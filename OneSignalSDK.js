! function(e) {
    ...
    var s = n(44),
        ...
        f = function() {
            ...
            return e.getBuildEnv = function() {
                        ...
                        switch (r.label) {
                            case 0:
                                ...
                                if (n = window === window.top, i = "https:" === window.location.protocol, void 0 === t) {
                                    if ("undefined" == typeof OneSignal) throw new c.InvalidArgumentError("usingProxyOrigin", c.InvalidArgumentReason
                                        .Empty);
                                    (o = OneSignal.context) && (t = !!o.appConfig.subdomain)
                                }
                                return n ? i ? [2, t ? l.IntegrationKind.SecureProxy : l.IntegrationKind.Secure] : [2, l.IntegrationKind
                                    .InsecureProxy
                                ] : [3, 1];
                            case 1:
                                return i ? [4, e.isFrameContextInsecure()] : [3, 3];
                            case 2:
                                return r.sent() ? [2, l.IntegrationKind.InsecureProxy] : [2, t ? l.IntegrationKind.SecureProxy : l.IntegrationKind
                                    .Secure
                                ];
                            case 3:
                ...
                return "undefined" == typeof window ? "undefined" != typeof self && void 0 !== self.registration ? u.WindowEnvironmentKind.ServiceWorker :
                    u.WindowEnvironmentKind.Unknown : window === window.top ? -1 !== location.href.indexOf("initOneSignal") || "/subscribe" ===
                    location.pathname && "" === location.search && (location.hostname.endsWith(".onesignal.com") || location.hostname.endsWith(
                        ".os.tc") || -1 !== location.hostname.indexOf(".localhost") && e.getBuildEnv() === s.BuildEnvironmentKind.Development) ? u.WindowEnvironmentKind
                    .OneSignalSubscriptionPopup : u.WindowEnvironmentKind.Host : "/webPushIframe" === location.pathname ? u.WindowEnvironmentKind.OneSignalProxyFrame :
                    "/webPushModal" === location.pathname ? u.WindowEnvironmentKind.OneSignalSubscriptionModal : u.WindowEnvironmentKind.CustomIframe
    ...
    (function(e) {
                ...
                function a(o) {
                    return function(a) {
                        return function(o) {
                            if (n) throw new TypeError("Generator is already executing.");
                            for (; s;) try {
                                if (n = 1, i && (r = i[2 & o[0] ? "return" : o[0] ? "throw" : "next"]) && !(r = r.call(i, o[1])).done)
                                    return r;
                                switch (i = 0, r && (o = [0, r.value]), o[0]) {
                                    case 0:
                                    case 1:
        ...
        function v() {
            if (!OneSignal.config) throw new Error("(" + c.default.getWindowEnv().toString() +
                ") isUsingSubscriptionWorkaround() cannot be called until OneSignal.config exists.");
            return !s.default.safari && (!(m() && "localhost" === location.hostname || "127.0.0.1" === location.hostname) && !(c.default.getWindowEnv() !==
                l.WindowEnvironmentKind.Host && c.default.getWindowEnv() !== l.WindowEnvironmentKind.CustomIframe || !OneSignal.config.subdomain &&
        ...
        t.decodeHtmlEntities = function(e) {
            ...
            return !(!e.safari && void 0 === navigator.serviceWorker || e.ios || e.ipod || e.iphone || e.ipad || e.msie || !(e.msedge && Number(
                e.version) >= 17.17063) && (t.indexOf("FBAN") > -1 || t.indexOf("FBAV") > -1 || navigator.appVersion.match(/ wv/) || e.firefox &&
                Number(e.version) < 48 && (e.mobile || e.tablet) || !(e.firefox && Number(e.version) >= 44) && !(e.safari && Number(e.version) >=
                    7.1) && !(e.samsungBrowser && Number(e.version) >= 4) && !((e.chrome || e.chromium) && Number(e.version) >= 42) &&
                !(e.yandexbrowser && Number(e.version) >= 15.12) && !(e.opera && (e.mobile || e.tablet) && Number(e.version) >= 37 || e
                    .opera && Number(e.version) >= 42) && !e.vivaldi))
        ...
        function y(e) {
            return "code" == e ?
                ...
                "bold" == e ? "font-weight: 600;color: rgb(51, 51, 51);" : "alert" == e ? "font-weight: 600;color: red;" : "event" == e ?
                "color: green;" : "postmessage" == e ? "color: orange;" : "serviceworkermessage" == e ? "color: purple;" : ""
        }
        ...
        function O() {
            return f.default.warn("OneSignal: Unsubscribing from push."), c.default.getWindowEnv() !== l.WindowEnvironmentKind.ServiceWorker ? self
                .registration.pushManager.getSubscription().then(function(e) {
                    if (e) return e.unsubscribe();
                    throw new Error("Cannot unsubscribe because not subscribed.")
                }) : v() ? new Promise(function(e, t) {
                    f.default.debug("Unsubscribe from push got called, and we're going to remotely execute it in HTTPS iFrame."), OneSignal.proxyFrameHost
                        .message(OneSignal.POSTMAM_COMMANDS.UNSUBSCRIBE_FROM_PUSH, null, function(n) {
                            f.default.debug("Unsubscribe from push succesfully remotely executed."), n.data === OneSignal.POSTMAM_COMMANDS.REMOTE_OPERATION_COMPLETE ?
                                e() : t("Failed to remotely unsubscribe from push.")
                        })
        ...
        function _() {
            return f.default.warn("OneSignal: Unregistering service worker."), c.default.getWindowEnv() === l.WindowEnvironmentKind.OneSignalProxyFrame ?
                Promise.resolve() : navigator.serviceWorker && navigator.serviceWorker.controller ? navigator.serviceWorker.ready.then(function(e) {
                    return e.unregister()
                }) : Promise.resolve()
        }
        ...
        t.getConsoleStyle = y, t.delay = function(e) {
            ...
            return f.default.warn("OneSignal: Wiping IndexedDB data."), Promise.all([d.default.remove("Ids"), d.default.remove(
                "NotificationOpened"), d.default.remove("Options")])
            ...
            if (void 0 === r && (r = !1), n || f.default.error("Cannot call on() with no event: ", n), i || f.default.error(
                    "Cannot call on() with no task: ", i), "string" == typeof t) {
    ...
    Object.defineProperty(t, "__esModule", {
            value: !0
        }), (i = t.WindowEnvironmentKind || (t.WindowEnvironmentKind = {})).ServiceWorker = "ServiceWorker", i.Host = "Host", i.OneSignalSubscriptionPopup =
        "Popup", i.OneSignalSubscriptionModal = "Modal", i.OneSignalProxyFrame = "ProxyFrame", i.CustomIframe = "CustomFrame", i.Unknown = "Unknown"
}, function(e, t, n) {
    "use strict";
    ...
    var r = i(n(4)),
        ...
        a = n(1),
        u = i(n(2)),
        c = ["notifyButtonHovering", "notifyButtonHover", "notifyButtonButtonClick", "notifyButtonLauncherClick", "animatedElementHiding",
            "animatedElementHidden", "animatedElementShowing", "animatedElementShown", "activeAnimatedElementActivating", "activeAnimatedElementActive",
            "activeAnimatedElementInactivating", "activeAnimatedElementInactive", "dbRetrieved", "dbSet", "testEvent"
        ],
        l = ["onesignal.prompt.custom.clicked", "onesignal.prompt.native.permissionchanged", "onesignal.subscription.changed",
            "onesignal.internal.subscriptionset", "dbRebuilt", "initialize", "subscriptionSet", "sendWelcomeNotification", "subscriptionChange",
            "notificationPermissionChange", "dbSet", "register", "notificationDisplay", "notificationDismiss", "notificationClick",
            "permissionPromptDisplay", "testWouldDisplay", "testInitOptionDisabled", "popupWindowTimeout"
        ],
        d = {
        ...
        f = function() {
            ...
            return e.trigger = function(t, n, i) {
                if (void 0 === i && (i = null), !a.contains(c, t)) {
                    var f = n;
                    if (i) var p = a.capitalize(o.default.getWindowEnv().toString()) + " ⬸ " + a.capitalize(i);
                    else p = a.capitalize(o.default.getWindowEnv().toString());
                    f || !1 === f ? u.default.debug("(" + p + ") » %c" + t + ":", a.getConsoleStyle("event"), f) : u.default.debug("(" + p +
                        ") » %c" + t, a.getConsoleStyle("event"))
                }
                ...
                }!r.default.isBrowser() || o.default.getWindowEnv() !== s.WindowEnvironmentKind.OneSignalSubscriptionPopup && o.default.getWindowEnv() !==
                    s.WindowEnvironmentKind.OneSignalProxyFrame || (opener || parent ? a.contains(l, t) && (o.default.getWindowEnv() === s.WindowEnvironmentKind
                        .OneSignalSubscriptionPopup ? OneSignal.subscriptionPopup.message(OneSignal.POSTMAM_COMMANDS.REMOTE_RETRIGGER_EVENT, {
                            eventName: t,
                            eventData: n
                        }) : OneSignal.proxyFrame.retriggerRemoteEvent(t, n)) : u.default.error("Could not send event '" + t +
                        "' back to host page because no creator (opener or parent) found!"))
    ...
    i = function() {
        ...
        function t(t) {
            ...
            /opera/i.test(t) ? i = {
                ...
                }, !i.msedge && /(apple)?webkit/i.test(t) ? (/(apple)?webkit\/537\.36/i.test(t) ? (i.name = i.name || "Blink", i.blink = e) : (i.name =
                    i.name || "Webkit", i.webkit = e), !i.version && y && (i.version = y)) : !i.opera && /gecko\//i.test(t) && (i.name = i.name ||
                    "Gecko", i.gecko = e, i.version = i.version || n(/gecko\/(\d+(\.\d+)?)/i)), i.windowsphone || i.msedge || !a && !i.silk ? i.windowsphone ||
                i.msedge || !s ? m ? i.mac = e : _ ? i.xbox = e : b ? i.windows = e : v && (i.linux = e) : (i[s] = e, i.ios = e) : i.android = e;
            var E = "";
            i.windows ? E = function(e) {
                ...
                }(n(/Windows ((NT|XP)( \d\d?.\d)?)/i)) : i.windowsphone ? E = n(/windows phone (?:os)?\s?(\d+(\.\d+)*)/i) : i.mac ? E = (E = n(
                    /Mac OS X (\d+([_\.\s]\d+)*)/i)).replace(/[_\s]/g, ".") : s ? E = (E = n(/os (\d+([_\s]\d+)*) like mac os x/i)).replace(
                    /[_\s]/g, ".") : a ? E = n(/android[ \/-](\d+(\.\d+)*)/i) : i.webos ? E = n(/(?:web|hpw)os\/(\d+(\.\d+)*)/i) : i.blackberry ? E =
                n(/rim\stablet\sos\s(\d+(\.\d+)*)/i) : i.bada ? E = n(/bada\/(\d+(\.\d+)*)/i) : i.tizen && (E = n(/tizen[\/\s](\d+(\.\d+)*)/i)), E &&
                (i.osversion = E);
            var P = !i.windows && E.split(".")[0];
            return w || c || "ipad" == s || a && (3 == P || P >= 4 && !O) || i.silk ? i.tablet = e : (O || "iphone" == s || "ipod" == s || a || u ||
                    i.blackberry || i.webos || i.bada) && (i.mobile = e), i.msedge || i.msie && i.version >= 10 || i.yandexbrowser && i.version >=
                15 || i.vivaldi && i.version >= 1 || i.chrome && i.version >= 20 || i.samsungBrowser && i.version >= 4 || i.firefox && i.version >=
                20 || i.safari && i.version >= 6 || i.opera && i.version >= 10 || i.ios && i.osversion && i.osversion.split(".")[0] >= 6 || i.blackberry &&
                i.version >= 10.1 || i.chromium && i.version >= 20 ? i.a = e : i.msie && i.version < 10 || i.chrome && i.version < 20 || i.firefox &&
                i.version < 20 || i.safari && i.version < 6 || i.opera && i.version < 10 || i.ios && i.osversion && i.osversion.split(".")[0] < 6 ||
                i.chromium && i.version < 20 ? i.c = e : i.x = e, i
        }
    ...
    var m = function() {
        ...
        return e.applyDbResultFilter = function(e, t, n) {
                            ...
                            return [4, new Promise(function(s) {
                                return i(o, void 0, void 0, function() {
                                    ...
                                    return r(this, function(r) {
                                        switch (r.label) {
                                            case 0:
                                                return u.default.getWindowEnv() !== p.WindowEnvironmentKind
                                                    .ServiceWorker && b.isUsingSubscriptionWorkaround() &&
                                                    u.default.getTestEnv() === f.TestEnvironmentKind
                                                    .None ? (OneSignal.proxyFrameHost.message(
                                            ...
                                            case 2:
                                                i = r.sent(), o = e.applyDbResultFilter(t, n, i), s(
                                                    o), r.label = 3;
                                            case 3:
                                                return [2]
                                        }
                                            ...
                                            case 0:
                                                return u.default.getWindowEnv() !== p.WindowEnvironmentKind
                                                    ...
                                                    .None ? (OneSignal.proxyFrameHost.message(
                                                        ...
                                                        function(i) {
                                                            i.data === OneSignal.POSTMAM_COMMANDS
                                                                .REMOTE_OPERATION_COMPLETE ? e() :
                                                                s(
                                                                    "(Database) Attempted remote IndexedDB put(" +
                                                                    t + ", " + n +
            ...
            return u.default.getWindowEnv() !== p.WindowEnvironmentKind.ServiceWorker && b.isUsingSubscriptionWorkaround() && u.default.getTestEnv() ===
                f.TestEnvironmentKind.None ? new Promise(function(n, i) {
                    OneSignal.proxyFrameHost.message(OneSignal.POSTMAM_COMMANDS.REMOTE_DATABASE_REMOVE, [{
                        table: e,
                        keypath: t
                    }], function(r) {
                        r.data === OneSignal.POSTMAM_COMMANDS.REMOTE_OPERATION_COMPLETE ? n() : i(
            ...
            return i(this, void 0, void 0, function() {
                ...
                return r(this, function(r) {
                    switch (r.label) {
                        ...
                        case 7:
                            return n < i.length ? (o = i[n], (s = e.clickedNotifications[o]) ? [4, this.put(
                                "NotificationOpened", {
                                    url: o,
                                    data: s.data,
            ...
            return i(this, void 0, void 0, function() {
                ...
                return r(this, function(r) {
                    switch (r.label) {
                        ...
                        case 6:
                            return a = r.sent(), e.optedOut = null != i ? i : null != o && !o, e.createdAt = s, e.expirationTime =
                                a, [2, e]
                    }
                })
            })
            ...
            return i(this, void 0, void 0, function() {
                return r(this, function(t) {
                    return e.ensureSingletonInstance(), [2, Promise.all([e.databaseInstance.remove("Ids"), e.databaseInstance.remove(
                        "NotificationOpened"), e.databaseInstance.remove("Options")])]
                })
            })
    ...
    var a = s(n(57)),
        ...
        b = function() {
            ...
            return e.get = function(t, n, i) {
                ...
                var t = e.errors;
                return l.contains(t, "No user with this id found") || l.contains(t, "Could not find app_id for given player id.") ?
                    "no-user-id-error" : "unknown-error"
                ...
                return i && (c.headings = i), o && (c.url = o), s && (c.chrome_web_icon = s, c.firefox_icon = s), l.trimUndefined(c), e.post(
                    "notifications", c)
                        ...
                        switch (n.label) {
                            case 0:
                                return n.trys.push([0, 2, , 3]), [4, new Promise(function(n, i) {
                                    c.default.getWindowEnv() !== f.WindowEnvironmentKind.ServiceWorker ? a.default(c.default
                                        .getOneSignalApiUrl().toString() + "/sync/" + t + "/web", null,
                                        function(e, t) {
                ...
                return r(this, void 0, void 0, function() {
                    ...
                    return o(this, function(o) {
                        switch (o.label) {
                            case 0:
                                return (r = new g.EmailDeviceRecord(n.emailAddress, n.emailAuthHash)).appId = t.appId, r.pushDeviceRecordId =
                                    i, [4, e.post("players", r.serialize())];
                            case 1:
                ...
                return r(this, void 0, void 0, function() {
                    ...
                    return o(this, function(o) {
                        switch (o.label) {
                            case 0:
                                return (r = new g.EmailDeviceRecord(n.emailAddress, n.emailAuthHash)).appId = t.appId, r.pushDeviceRecordId =
                                    i, [4, e.put("players/" + n.emailId, r.serialize())];
                            case 1:
                                return (s = o.sent()) && s.success ? [2, s.id] : [2, null]
                        }
                    })
                ...
                return r(this, void 0, void 0, function() {
                    ...
                    return o(this, function(o) {
                        switch (o.label) {
                            ...
                            case 2:
                                throw (r = o.sent()) && Array.isArray(r.errors) && r.errors.length > 0 && l.contains(r.errors[0],
                                    "app_id not found") ? new d.OneSignalApiError(d.OneSignalApiErrorKind.MissingAppId) : r;
                            case 3:
                                return [2]
                        }
                    })
    ...
    var s, a = o(n(6));
    (s = t.PushPermissionNotGrantedErrorReason || (t.PushPermissionNotGrantedErrorReason = {}))[s.Blocked = 0] = "Blocked", s[s.Dismissed = 1] =
        "Dismissed", s[s.Default = 2] = "Default";
    ...
    var s, a = o(n(6)),
        u = n(41);
    (s = t.InvalidStateReason || (t.InvalidStateReason = {}))[s.MissingAppId = 0] = "MissingAppId", s[s.RedundantPermissionMessage = 1] =
        "RedundantPermissionMessage", s[s.PushPermissionAlreadyGranted = 2] = "PushPermissionAlreadyGranted", s[s.UnsupportedEnvironment = 3] =
        "UnsupportedEnvironment", s[s.MissingDomElement = 4] = "MissingDomElement", s[s.ServiceWorkerNotActivated = 5] = "ServiceWorkerNotActivated", s[
            s.NoProxyFrame = 6] = "NoProxyFrame";
        ...
        function InvalidStateError(n, i) {
            ...
            switch (n) {
                ...
                case t.InvalidStateReason.RedundantPermissionMessage:
                    var o = "";
                    i.permissionPromptType && (o = "(" + u.PermissionPromptType[i.permissionPromptType] + ")"), r = e.call(this,
                        "Another permission message " + o + " is being displayed.") || this;
                    break;
    ...
    var s, a = o(n(6));
    (s = t.InvalidArgumentReason || (t.InvalidArgumentReason = {}))[s.Empty = 0] = "Empty", s[s.Malformed = 1] = "Malformed", s[s.EnumOutOfRange = 2] =
        "EnumOutOfRange";
    ...
    Object.defineProperty(t, "__esModule", {
        value: !0
    }), (i = t.SubscriptionStateKind || (t.SubscriptionStateKind = {}))[i.Subscribed = 1] = "Subscribed", i[i.MutedByApi = -2] = "MutedByApi", i[i.NotSubscribed = -
        10] = "NotSubscribed", i[i.TemporaryWebRecord = -20] = "TemporaryWebRecord", i[i.PermissionRevoked = -21] = "PermissionRevoked", i[i.PushSubscriptionRevoked = -
        22] = "PushSubscriptionRevoked"
}, function(e, t, n) {
    "use strict";
    var i = this && this.__awaiter || function(e, t, n, i) {
            return new(n || (n = Promise))(function(r, o) {
    ...
    var s, a = n(13),
        ...
        d = o(n(4)),
        f = o(n(2));
    (s = t.WorkerMessengerCommand || (t.WorkerMessengerCommand = {})).WorkerVersion = "GetWorkerVersion", s.Subscribe = "Subscribe", s.SubscribeNew =
        "SubscribeNew", s.AmpSubscriptionState = "amp-web-push-subscription-state", s.AmpSubscribe = "amp-web-push-subscribe", s.AmpUnsubscribe =
        "amp-web-push-unsubscribe", s.NotificationDisplayed = "notification.displayed", s.NotificationClicked = "notification.clicked", s.NotificationDismissed =
        "notification.dismissed", s.RedirectPage = "command.redirect";
    var p = function() {
        function e() {
            this.replies = {}
        }
    ...
    var h = function() {
        ...
        return e.prototype.broadcast = function(e, t) {
            return i(this, void 0, void 0, function() {
                ...
                return r(this, function(r) {
                    switch (r.label) {
                        ...
                        case 2:
                            for (n = r.sent(), i = 0, o = n; i < o.length; i++) s = o[i], f.default.debug(
                                "[Worker Messenger] [SW -> Page] Broadcasting '" + e.toString() + "' to window client " + s
                                .url + "."), s.postMessage({
                                command: e,
                                payload: t
                            });
                ...
                return r(this, function(i) {
                    switch (i.label) {
                        case 0:
                            ...
                            return f.default.debug("[Worker Messenger] [SW -> Page] Unicasting '" + e.toString() +
                                "' to window client " + n.url + "."), n.postMessage({
                                command: e,
                                payload: t
                            }), [3, 4];
                        case 1:
                        ...
                        case 2:
                            return i.sent() || f.default.debug(
                                "[Worker Messenger] The page is not controlled by the service worker yet. Waiting...", self
                                .registration), [4, this.waitUntilWorkerControlsPage()];
                        case 3:
                            i.sent(), f.default.debug("[Worker Messenger] [Page -> SW] Unicasting '" + e.toString() +
                                "' to service worker."), navigator.serviceWorker.controller.postMessage({
                                command: e,
                                payload: t
                            }), i.label = 4;
                        case 4:
            ...
            d.default.supportsServiceWorkers() && (u.default.getWindowEnv() === l.WindowEnvironmentKind.ServiceWorker ? (self.addEventListener(
                "message", this.onWorkerMessageReceivedFromPage.bind(this)), f.default.debug(
                "[Worker Messenger] Service worker is now listening for messages.")) : this.listenForPage(e))
            ...
            return i(this, void 0, void 0, function() {
                return r(this, function(t) {
                    switch (t.label) {
                        ...
                        case 1:
                            return t.sent() || f.default.debug("(" + location.origin +
                                ") [Worker Messenger] The page is not controlled by the service worker yet. Waiting...",
                                self.registration), [4, this.waitUntilWorkerControlsPage()];
                        case 2:
                            t.sent(), f.default.debug("(" + location.origin +
                                ") [Worker Messenger] The page is now controlled by the service worker."), t.label = 3;
                        case 3:
                            return navigator.serviceWorker.addEventListener("message", this.onPageMessageReceivedFromServiceWorker
                                .bind(this)), f.default.debug("(" + location.origin +
                                ") [Worker Messenger] Page is now listening for messages."), [2]
                    }
                })
            })
            ...
            return i(this, void 0, void 0, function() {
                ...
                return r(this, function(t) {
                    switch (t.label) {
                        case 0:
                            return u.default.getWindowEnv() !== l.WindowEnvironmentKind.ServiceWorker ? [3, 1] : [2, !!self.registration
                                .active
                            ];
                        case 1:
                            return [4, this.context.serviceWorkerManager.getActiveState()];
                        case 2:
                            return [2, (e = t.sent()) === c.ServiceWorkerActiveState.WorkerA || e === c.ServiceWorkerActiveState
                                .WorkerB
                            ]
                    }
                })
                            ...
                            return r(this, function(n) {
                                switch (n.label) {
                                    case 0:
                                        return [4, this.isWorkerControllingPage()];
                                    case 1:
                                        return n.sent() ? t() : u.default.getWindowEnv() === l.WindowEnvironmentKind
                                            .ServiceWorker ? self.addEventListener("activate",
                                                function(n) {
                                                    return i(e, void 0, void 0, function() {
                                                        return r(this, function(e) {
                                                            switch (e.label) {
    ...
    var s, a = o(n(4)),
        ...
        v = o(n(2)),
        S = o(n(5));
    (s = t.ServiceWorkerActiveState || (t.ServiceWorkerActiveState = {})).WorkerA = "Worker A (Main)", s.WorkerB = "Worker B (Updater)", s.ThirdParty =
        "3rd Party", s.Installing = "Installing", s.None = "None", s.Bypassed = "Bypassed", s.Indeterminate = "Indeterminate";
    var y = function() {
        function e(e, t) {
        ...
        return e.prototype.getActiveState = function() {
            return i(this, void 0, void 0, function() {
                ...
                return r(this, function(r) {
                    switch (r.label) {
                        ...
                        case 1:
                            return (e = r.sent()) !== g.IntegrationKind.InsecureProxy ? [3, 2] : [2, t.ServiceWorkerActiveState
                                .Indeterminate
                            ];
                        case 2:
                        ...
                        case 11:
                            return r.sent(), [3, 12];
                        case 12:
                            return o ? o.installing ? [2, t.ServiceWorkerActiveState.Installing] : o.active ? (s = new URL(o.active
                                    .scriptURL).pathname, a = new l.default(s).getFileName() == this.config.workerAPath.getFileName() ?
                                t.ServiceWorkerActiveState.WorkerA : new l.default(s).getFileName() == this.config.workerBPath
                                .getFileName() ? t.ServiceWorkerActiveState.WorkerB : t.ServiceWorkerActiveState.ThirdParty,
                                navigator.serviceWorker.controller || a !== t.ServiceWorkerActiveState.WorkerA && a !== t.ServiceWorkerActiveState
                                .WorkerB ? [2, a] : [2, t.ServiceWorkerActiveState.Bypassed]) : [2, t.ServiceWorkerActiveState
                                .ThirdParty
                            ] : [2, t.ServiceWorkerActiveState.None]
                    }
                })
            })
                    ...
                    return [2, new Promise(function(t) {
                        return i(e, void 0, void 0, function() {
                            ...
                            return r(this, function(i) {
                                switch (i.label) {
                                    case 0:
                                        return p.isUsingSubscriptionWorkaround() ? (e = OneSignal.proxyFrameHost) ?
                                            [3, 1] : (t(NaN), [3, 3]) : [3, 4];
                                    case 1:
                                    ...
                                    case 3:
                                        return [3, 5];
                                    case 4:
                                        this.context.workerMessenger.once(c.WorkerMessengerCommand.WorkerVersion,
                                            function(e) {
                                                t(e)
                                            }), this.context.workerMessenger.unicast(c.WorkerMessengerCommand
                                            .WorkerVersion), i.label = 5;
                                    case 5:
                                        return [2]
                                }
                            })
            ...
            return i(this, void 0, void 0, function() {
                ...
                return r(this, function(n) {
                    switch (n.label) {
                        ...
                        case 1:
                            return (e = n.sent()) !== t.ServiceWorkerActiveState.WorkerA && e !== t.ServiceWorkerActiveState.WorkerB ?
                                [2, !0] : [2, !1]
                    }
                })
            })
                ...
                return r(this, function(i) {
                    switch (i.label) {
                        case 0:
                            return [4, this.getActiveState()];
                        case 1:
                            if ((e = i.sent()) !== t.ServiceWorkerActiveState.WorkerA && e !== t.ServiceWorkerActiveState.WorkerB)
                                throw new u.InvalidStateError(u.InvalidStateReason.ServiceWorkerNotActivated);
                            return [2, new Promise(function(e) {
                                n.context.workerMessenger.once(c.WorkerMessengerCommand.Subscribe, function(t) {
                                    e(f.Subscription.deserialize(t))
                                }), n.context.workerMessenger.unicast(c.WorkerMessengerCommand.Subscribe, n.context
                                    .appConfig)
                            })]
                    }
                })
            ...
            return i(this, void 0, void 0, function() {
                ...
                return r(this, function(i) {
                    switch (i.label) {
                        ...
                        case 1:
                            e = i.sent(), v.default.info("[Service Worker Update] Checking service worker version..."), i.label =
                                2;
                        case 2:
                        ...
                        case 3:
                            return n = i.sent(), [3, 5];
                        case 4:
                            return i.sent(), v.default.info(
                                    "[Service Worker Update] Worker did not reply to version query; assuming older version."),
                                n = 1, [3, 5];
                        case 5:
                            return e !== t.ServiceWorkerActiveState.WorkerA && e !== t.ServiceWorkerActiveState.WorkerB ? (v.default
                                .debug(
                                    "[Service Worker Update] Not updating service worker, current active worker state is " +
                                    e + "."), [2]) : (n !== a.default.version() ? (v.default.info(
                                "[Service Worker Update] Updating service worker from v" + n + " --\x3e v" + a.default
                                .version() + "."), this.installWorker()) : v.default.info(
                                "[Service Worker Update] Service worker version is current at v" + n +
                                " (no update required)."), [2])
                    }
                })
            })
                                    ...
                                    return r(this, function(a) {
                                        switch (a.label) {
                                            case 0:
                                                return [4, this.getActiveState()];
                                            case 1:
                                                return n = a.sent(), e !== n && n !== t.ServiceWorkerActiveState
                                                    .Installing ? o() : navigator.serviceWorker.addEventListener(
                                                        "controllerchange",
                                                        function(n) {
            ...
            t.off(), t.on(c.WorkerMessengerCommand.NotificationDisplayed, function(e) {
                v.default.debug(location.origin, "Received notification display event from service worker."), S.default.trigger(
                    OneSignal.EVENTS.NOTIFICATION_DISPLAYED, e)
                ...
                return i(e, void 0, void 0, function() {
                    ...
                    return r(this, function(i) {
                        switch (i.label) {
                            case 0:
                                return d.default.getWindowEnv() !== b.WindowEnvironmentKind.OneSignalProxyFrame ? [3, 2] :
                                    [4, new Promise(function(e) {
                                        var t = OneSignal.proxyFrame;
                                        t && t.messenger.message(OneSignal.POSTMAM_COMMANDS.GET_EVENT_LISTENER_COUNT,
                ...
                v.default.debug(d.default.getWindowEnv().toString() + " Picked up command.redirect to " + e +
                    ", forwarding to host page.");
                var t = OneSignal.proxyFrame;
                ...
                return r(this, function(r) {
                    switch (r.label) {
                        case 0:
                            return [4, this.getActiveState()];
                        case 1:
                            return (e = r.sent()) !== t.ServiceWorkerActiveState.ThirdParty ? [3, 4] : [4, navigator.serviceWorker
                                .getRegistration()
                            ];
                        case 2:
                        ...
                        case 3:
                            r.sent(), r.label = 4;
                        case 4:
                            if (e === t.ServiceWorkerActiveState.WorkerA) n = this.config.workerBPath.getPathWithoutFileName(),
                                i = this.config.workerBPath.getFileName();
                            else if (e === t.ServiceWorkerActiveState.WorkerB || e === t.ServiceWorkerActiveState.ThirdParty ||
                                e === t.ServiceWorkerActiveState.None) n = this.config.workerAPath.getPathWithoutFileName(), i =
                                this.config.workerAPath.getFileName();
                            else if (e === t.ServiceWorkerActiveState.Bypassed) throw new u.InvalidStateError(u.InvalidStateReason
                                .UnsupportedEnvironment);
                            return s = {
                                appId: this.context.appConfig.appId
                            }, o = n + "/" + i + "?" + p.encodeHashAsUriComponent(s), v.default.info(
                                "[Service Worker Installation] Installing service worker " + o + "."), [4, navigator.serviceWorker
                                .register(o, this.config.registrationOptions)
                            ];
                        case 5:
    ...
    var s, a = o(n(6));
    (s = t.SdkInitErrorKind || (t.SdkInitErrorKind = {}))[s.InvalidAppId = 0] = "InvalidAppId", s[s.AppNotConfiguredForWebPush = 1] =
        "AppNotConfiguredForWebPush", s[s.MissingSubdomain = 2] = "MissingSubdomain", s[s.WrongSiteUrl = 3] = "WrongSiteUrl", s[s.MultipleInitialization =
        ...
        function SdkInitError(n, i) {
            ...
            switch (n) {
                ...
                case t.SdkInitErrorKind.WrongSiteUrl:
                    r = i && i.siteUrl ? e.call(this, "OneSignal: This web push config can only be used on " + new URL(i.siteUrl).origin +
                        ". Your current origin is " + location.origin + ".") || this : e.call(this,
                        "OneSignal: This web push config can not be used on the current site.") || this;
                    break;
    ...
    var s = o(n(7)),
        ...
        c = function(e) {
            ...
            return r(t, e), t.prototype.serialize = function() {
                ...
                return this.subscription && (t.identifier = s.default.safari ? this.subscription.safariDeviceToken : this.subscription.w3cEndpoint.toString(),
                    t.web_auth = this.subscription.w3cAuth, t.web_p256 = this.subscription.w3cP256dh), t
            }, t.createFromPushSubscription = function(e, n, i) {
                var r = new t(n);
                return r.appId = e, r.subscriptionState = n ? u.SubscriptionStateKind.Subscribed : u.SubscriptionStateKind.NotSubscribed, i && (r.subscriptionState =
                    i), r
    ...
    var a = s(n(4)),
        ...
        f = function() {
            function e(e, t, n) {
                if (this.windowReference = e, this.sendToOrigin = t, this.receiveFromOrigin = n, !window || !window.postMessage) throw new Error(
                    "Must pass in a valid window reference supporting postMessage():" + e);
                if (!t || !n) throw new Error("Invalid origin. Must be set.");
                this.emitter = new l.default, this.channel = new MessageChannel, this.messagePort = null, this.isListening = !1, this.isConnected = !1,
                    this.replies = {}
            }
            return Object.defineProperty(e, "HANDSHAKE_MESSAGE", {
                ...
                d.default.debug("(Postmam) Called listen()."), this.isListening ? d.default.debug(
                    "(Postmam) Already listening for Postmam connections.") : a.default.isBrowser() && (this.isListening = !0, d.default.debug(
                    "(Postmam) Listening for Postmam connections.", this), window.addEventListener("message", this.onWindowMessagePostmanConnectReceived
                    .bind(this)))
                ...
                if (this.isSafeOrigin(t.origin)) {
                    ...
                    if (this.replies.hasOwnProperty(r)) d.default.info("(Postmam) This message is a reply."), !1 === this.replies[r].bind(window)(c) &&
                        delete this.replies[r];
                    else this.emitter.emit(o, c)
                }
            }, e.prototype.onWindowMessagePostmanConnectReceived = function(t) {
                (d.default.debug("(Postmam) (" + u.default.getWindowEnv().toString() + ") Window postmessage for Postman connect received:", t),
                    this.isSafeOrigin(t.origin)) && (t.data.handshake === e.HANDSHAKE_MESSAGE ? (d.default.info(
                        "(Postmam) Got our expected Postmam handshake message (and connecting...):", t.data), window.removeEventListener(
                        "message", this.onWindowMessagePostmanConnectReceived), this.messagePort = t.ports[0], this.messagePort.addEventListener(
                        "message", this.onMessageReceived.bind(this), !1), d.default.info(
                        "(Postmam) Removed previous message event listener for handshakes, replaced with main message listener."), this.messagePort
                    .start(), this.isConnected = !0, d.default.info("(Postmam) (" + u.default.getWindowEnv().toString() + ") Connected."), this
                    .message(e.CONNECTED_MESSAGE), this.emitter.emit("connect")) : d.default.info(
                    "(Postmam) Got a postmam message, but not our expected handshake:", t.data))
            }, e.prototype.connect = function() {
                d.default.info("(Postmam) (" + u.default.getWindowEnv().toString() + ") Establishing a connection to " + this.sendToOrigin + "."),
                    this.messagePort = this.channel.port1, this.messagePort.addEventListener("message", this.onMessageReceived.bind(this), !1),
                    this.messagePort.start(), this.windowReference.postMessage({
                ...
                try {
                    var n = new URL(e),
                        i = n.host;
                    0 === n.host.indexOf("www.") && (i = n.host.replace("www.", "")), "https:" === n.protocol ? (t.push("https://" + i), t.push(
                        "https://www." + i)) : "http:" === n.protocol && (t.push("http://" + i), t.push("http://www." + i), t.push("https://" +
                        i), t.push("https://www." + i))
                } catch (e) {}
                return t
                ...
                return "https://onesignal.com" === e || e === "https://" + (t || "") + ".onesignal.com" || e === "https://" + (t || "") + ".os.tc" ||
                    e === "https://" + (t || "") + ".os.tc:3001" || e === u.default.getOneSignalApiUrl().origin || "*" === this.receiveFromOrigin ||
                    c.contains(n, e)
            ...
            return e.fixWordpressManifestIfMisplaced = function() {
                ...
                if (e && !(e.length <= 1))
                    for (var t = 0; t < e.length; t++) {
                        var n = e[t],
                            i = n.href;
                        l.contains(i, "gcm_sender_id") && (document.querySelector("head").insertBefore(n, document.querySelector("head").children[0]),
                            f.default.info("OneSignal: Moved the WordPress push <manifest> to the first element in <head>."))
                    }
                ...
                return i(this, void 0, void 0, function() {
                    ...
                    return r(this, function(r) {
                        switch (r.label) {
                            ...
                            case 3:
                                if ((i = r.sent()).errors) throw f.default.error("API call %c" + n, l.getConsoleStyle("code"),
                                    "failed with:", i.errors), new Error("Failed to get notification icons.");
                                return [2, i]
                        }
                    })
                })
                ...
                if (t) {
                    ...
                    for (var a = ["autoAcceptTitle", "siteName", "autoAcceptTitle", "subscribeText", "showGraphic", "actionMessage",
                            "exampleNotificationTitle", "exampleNotificationMessage", "exampleNotificationCaption", "acceptButtonText",
                            "cancelButtonText", "timeout"
                        ], u = {}, c = 0; c < a.length; c++) {
                        var l = a[c],
                            d = t[l],
    ...
    var r = i(n(7)),
        ...
        l = function() {
            function e() {
                this.language = o.default.getLanguage(), this.timezone = -60 * (new Date).getTimezoneOffset(), this.browserName = r.default.name, this.browserVersion =
                    NaN !== parseInt(String(r.default.version)) ? parseInt(String(r.default.version)) : -1, this.operatingSystem = this.getBrowserOperatingSystem(),
                    this.operatingSystemVersion = String(r.default.osversion), this.devicePlatform = this.getDevicePlatform(), this.deviceModel =
                    navigator.platform, this.sdkVersion = o.default.version().toString(), this.deliveryPlatform = this.getDeliveryPlatform()
            }
            return e.prototype.getDevicePlatform = function() {
                ...
                return r.default.mac ? "Mac OS X" : r.default.windows ? "Microsoft Windows" : r.default.windowsphone ? "Microsoft Windows Phone" :
                    r.default.linux ? "Linux" : r.default.chromeos ? "Google Chrome OS" : r.default.android ? "Google Android" : r.default.ios ?
                    "Apple iOS" : r.default.blackberry ? "Blackberry" : r.default.firefoxos ? "Mozilla Firefox OS" : r.default.webos ? "WebOS" : r.default
                    .tizen ? "Tizen" : r.default.sailfish ? "Sailfish OS" : "Unknown"
            }, e.prototype.getDeliveryPlatform = function() {
                var e = c.redetectBrowserUserAgent();
                return this.isSafari() ? a.DeliveryPlatformKind.Safari : e.firefox ? a.DeliveryPlatformKind.Firefox : e.msedge ? a.DeliveryPlatformKind
                    .Edge : a.DeliveryPlatformKind.ChromeLike
    ...
    var i = function() {
        ...
        return e.prototype.serialize = function() {
            ...
            var n = new e;
            return n.deviceId = t.deviceId, n.subscriptionToken = t.subscriptionToken, n.optedOut = t.optedOut, n.createdAt = t.createdAt, n.expirationTime =
                t.expirationTime, n
        }, e
    }();
    t.Subscription = i
    ...
    }(a || (a = {})), (u = t.IntegrationConfigurationKind || (t.IntegrationConfigurationKind = {}))[u.Dashboard = 0] = "Dashboard", u[u.JavaScript = 1] =
        "JavaScript";
    var g = function() {
        function e() {}
            ...
            return r(this, void 0, void 0, function() {
                ...
                return o(this, function(r) {
                    switch (r.label) {
                        ...
                        case 1:
                            if (t = r.sent(), (n = this.getMergedConfig(e, t)).restrictedOriginEnabled && p.default.getWindowEnv() !==
                                h.WindowEnvironmentKind.ServiceWorker && window.top === window && !f.contains(window.location.hostname,
                                    ".os.tc") && !f.contains(window.location.hostname, ".onesignal.com") && !this.doesCurrentOriginMatchConfigOrigin(
            ...
            switch (this.getIntegrationCapabilities(e).configuration) {
                ...
                case t.IntegrationConfigurationKind.JavaScript:
                    return i({}, n, {
                        ...
                        serviceWorkerPath: "undefined" != typeof OneSignal && OneSignal.SERVICE_WORKER_PATH ? OneSignal.SERVICE_WORKER_PATH :
                            "OneSignalSDKWorker.js",
                        serviceWorkerUpdaterPath: "undefined" != typeof OneSignal && OneSignal.SERVICE_WORKER_UPDATER_PATH ? OneSignal.SERVICE_WORKER_UPDATER_PATH :
    ...
    Object.defineProperty(t, "__esModule", {
        ...
        for (var t = (e + "=".repeat((4 - e.length % 4) % 4)).replace(/\-/g, "+").replace(/_/g, "/"), n = atob(t), i = new Uint8Array(n.length), r =
                0; r < n.length; ++r) i[r] = n.charCodeAt(r);
        return i
    }, t.arrayBufferToBase64 = function(e) {
        for (var t, n = "", i = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", r = new Uint8Array(e), o = r.byteLength, s = o %
                3, a = o - s, u = 0; u < a; u += 3) n += i[(16515072 & (t = r[u] << 16 | r[u + 1] << 8 | r[u + 2])) >> 18] + i[(258048 & t) >> 12] +
            i[(4032 & t) >> 6] + i[63 & t];
        return 1 == s ? n += i[(252 & (t = r[a])) >> 2] + i[(3 & t) << 4] + "==" : 2 == s && (n += i[(64512 & (t = r[a] << 8 | r[a + 1])) >> 10] +
            i[(1008 & t) >> 4] + i[(15 & t) << 2] + "="), n
    ...
    var i = function() {
        ...
        return e.prototype.isNewSubscription = function() {
            return this.existingW3cPushSubscription ? this.existingW3cPushSubscription.w3cEndpoint.toString() !== this.w3cEndpoint.toString() ||
                this.existingW3cPushSubscription.w3cP256dh !== this.w3cP256dh || this.existingW3cPushSubscription.w3cAuth !== this.w3cAuth : !
                this.existingSafariDeviceToken || this.existingSafariDeviceToken !== this.safariDeviceToken
            ...
            return n.w3cP256dh = t.w3cP256dh, n.w3cAuth = t.w3cAuth, n.existingW3cPushSubscription = t.existingPushSubscription ? e.deserialize(
                    t.existingPushSubscription) : null, n.safariDeviceToken = t.safariDeviceToken, n.existingSafariDeviceToken = t.existingSafariDeviceToken,
                n
        }, e
    }();
    ...
    var s, a = o(n(6));
    (s = t.SubscriptionErrorReason || (t.SubscriptionErrorReason = {}))[s.InvalidSafariSetup = 0] = "InvalidSafariSetup", s[s.Blocked = 1] = "Blocked",
        s[s.Dismissed = 2] = "Dismissed";
    var u = function(e) {
        function n(n) {
            var i = this;
            switch (n) {
    ...
    var r = n(15),
        ...
        h = function() {
            return function(e) {
                this.appConfig = e, this.cookieSyncer = new u.default(this, e.cookieSyncEnabled), this.subscriptionManager = new s.SubscriptionManager(
                    this, {
                ...
                e.userConfig && (e.userConfig.path && (t.workerAPath = new c.default(e.userConfig.path + l.default.getBuildEnvPrefix() + e.userConfig
                        .serviceWorkerPath), t.workerBPath = new c.default(e.userConfig.path + l.default.getBuildEnvPrefix() + e.userConfig
                        .serviceWorkerUpdaterPath)), e.userConfig.serviceWorkerParam && (t.registrationOptions = e.userConfig.serviceWorkerParam)),
                    this.serviceWorkerManager = new o.ServiceWorkerManager(this, t), this.workerMessenger = new r.WorkerMessenger(this), this.dynamicResourceLoader =
                    new a.DynamicResourceLoader, this.sessionManager = new d.SessionManager, this.permissionManager = new f.default, this.metricsManager =
                    new p.default(e.metrics.enable, e.metrics.mixpanelReportingToken)
            }
        }();
    t.default = h
}, function(e, t, n) {
    ...
    Object.defineProperty(t, "__esModule", {
            value: !0
        }), (i = t.DeliveryPlatformKind || (t.DeliveryPlatformKind = {}))[i.ChromeLike = 5] = "ChromeLike", i[i.Safari = 7] = "Safari", i[i.Firefox = 8] =
        "Firefox", i[i.Edge = 12] = "Edge", i[i.Email = 11] = "Email"
}, function(e, t, n) {
    "use strict";
    var i, r = this && this.__extends || (i = Object.setPrototypeOf || {
                __proto__: []
    ...
    var s = o(n(9)),
        ...
        u = function(e) {
            ...
            return r(t, e), t.prototype.serialize = function() {
                var t = e.prototype.serialize.call(this);
                return this.email && (t.identifier = this.email), this.emailAuthHash && (t.email_auth_hash = this.emailAuthHash), this.pushDeviceRecordId &&
                    (t.device_player_id = this.pushDeviceRecordId), t
            }, t.prototype.deserialize = function(e) {
                throw new s.default
            }, t
        }(n(24).DeviceRecord);
    ...
    var h = function() {
        ...
        return Object.defineProperty(e, "MIXPANEL_REPORTING_URL", {
            ...
            var e = new Date;
            return e.getUTCMonth() + 1 <= 2 && e.getUTCDate() <= 10 && e.getUTCFullYear() <= 2018 && e.getUTCMonth() + 1 >= 2 && e.getUTCDate() >=
                8 && e.getUTCFullYear() >= 2018
        ...
        b = function() {
            function e(t) {
                ...
                if (this.options = {
                    ...
                    if (!c.contains(["small", "medium", "large"], this.options.size)) throw new Error("Invalid size " + this.options.size +
                        " for notify button. Choose among 'small', 'medium', or 'large'.");
                    if (!c.contains(["bottom-left", "bottom-right"], this.options.position)) throw new Error("Invalid position " + this.options.position +
                        " for notify button. Choose either 'bottom-left', or 'bottom-right'.");
                    if (!c.contains(["default", "inverse"], this.options.theme)) throw new Error("Invalid theme " + this.options.theme +
                        " for notify button. Choose either 'default', or 'inverse'.");
                    if (this.options.showLauncherAfter < 0) throw new Error("Invalid delay duration of " + this.options.showLauncherAfter +
                        " for showing the notify button. Choose a value above 0.");
                    if (this.options.showBadgeAfter < 0) throw new Error("Invalid delay duration of " + this.options.showBadgeAfter +
                        " for showing the notify button's badge. Choose a value above 0.");
                    this.size = this.options.size, this.position = this.options.position, this.text = this.options.text, this.text[
                            "tip.state.unsubscribed"] || (this.text["tip.state.unsubscribed"] = "Subscribe to notifications"), this.text[
                            "tip.state.subscribed"] || (this.text["tip.state.subscribed"] = "You're subscribed to notifications"), this.text[
                            "tip.state.blocked"] || (this.text["tip.state.blocked"] = "You've blocked notifications"), this.text["message.prenotify"] ||
                        (this.text["message.prenotify"] = "Click to subscribe to notifications"), this.text["message.action.subscribed"] || (this.text[
                            "message.action.subscribed"] = "Thanks for subscribing!"), this.text["message.action.resubscribed"] || (this.text[
                            "message.action.resubscribed"] = "You're subscribed to notifications"), this.text["message.action.subscribing"] || (this.text[
                            "message.action.subscribing"] = "Click <strong>{{prompt.native.grant}}</strong> to receive notifications"), this.text[
                            "message.action.unsubscribed"] || (this.text["message.action.unsubscribed"] = "You won't receive notifications again"),
                        this.text["dialog.main.title"] || (this.text["dialog.main.title"] = "Manage Site Notifications"), this.text[
                            "dialog.main.button.subscribe"] || (this.text["dialog.main.button.subscribe"] = "SUBSCRIBE"), this.text[
                            "dialog.main.button.unsubscribe"] || (this.text["dialog.main.button.unsubscribe"] = "UNSUBSCRIBE"), this.text[
                            "dialog.blocked.title"] || (this.text["dialog.blocked.title"] = "Unblock Notifications"), this.text[
                            "dialog.blocked.message"] || (this.text["dialog.blocked.message"] = "Follow these instructions to allow notifications:"),
                        this._launcher = N, this.state = e.STATES.UNINITIALIZED, this._ignoreSubscriptionState = !1, OneSignal.on(e.EVENTS.SUBSCRIBE_CLICK,
                            function() {
                            ...
                            A.hovering = !0, A.launcher.activateIfInactive(), A.message.shown || A.dialog.shown ? A.hovering = !1 : A.message.contentType !==
                                h.default.TYPES.MESSAGE ? new Promise(function(e) {
                                    ...
                                    A.message.content = c.decodeHtmlEntities(A.message.getTipForState()), A.message.contentType = h.default.TYPES
                                        .TIP, e()
                                }).then(function() {
                            ...
                            A.message.contentType !== h.default.TYPES.MESSAGE && A.dialog.hidden && (A.hovering && (A.hovering = !1, A.message.waitUntilShown()
                                .then(function() {
                                    return c.delay(h.default.TIMEOUT)
                                }).then(function() {
                                    return A.message.hide()
                                }).then(function() {
                                    A.launcher.wasInactive && A.dialog.hidden && (A.launcher.inactivate(), A.launcher.wasInactive =
                                        null)
                            ...
                            return i(A, void 0, void 0, function() {
                                ...
                                return r(this, function(r) {
                                    switch (r.label) {
                                        case 0:
                                            return 1 != t ? [3, 2] : (this.badge.shown && this.options.prenotify && this.badge.hide(),
                                                null !== this.dialog.notificationIcons ? [3, 2] : [4, u.default.getNotificationIcons()]
                                            );
                                        case 1:
                                            n = r.sent(), this.dialog.notificationIcons = n, r.label = 2;
                                        case 2:
                                            return OneSignal.getNotificationPermission(function(n) {
                                                i.setState(t ? e.STATES.SUBSCRIBED : "denied" === n ? e.STATES.BLOCKED : e.STATES
                                                    .UNSUBSCRIBED, i._ignoreSubscriptionState)
                                            }), [2]
                                    }
                                })
                            })
                        }), OneSignal.on(e.EVENTS.STATE_CHANGED, function(t) {
                            A.launcher.element && (t.to === e.STATES.SUBSCRIBED ? A.launcher.inactivate() : (t.to === e.STATES.UNSUBSCRIBED || e.STATES
                                .BLOCKED) && A.launcher.activate())
            ...
            return Object.defineProperty(e, "EVENTS", {
                ...
                return i(this, void 0, void 0, function() {
                    ...
                    return r(this, function(r) {
                        switch (r.label) {
                            ...
                            case 1:
                                return 0 !== r.sent() ? (g.default.debug("Not showing notify button because styles failed to load."), [
                                    2
                                ]) : (this.container && c.removeDomElement("#onesignal-bell-container"), c.addDomElement("body",
                                        "beforeend",
                                        ...
                                        '<div id="onesignal-bell-launcher" class="onesignal-bell-launcher"></div>'), c.addDomElement(
                                        this.launcher.selector, "beforeend",
                                        '<div class="onesignal-bell-launcher-button"></div>'), c.addDomElement(this.launcher.selector,
                                        "beforeend", '<div class="onesignal-bell-launcher-badge"></div>'), c.addDomElement(this
                                        .launcher.selector, "beforeend", '<div class="onesignal-bell-launcher-message"></div>'),
                                    c.addDomElement(this.message.selector, "beforeend",
                                        '<div class="onesignal-bell-launcher-message-body"></div>'), c.addDomElement(this.launcher
                                        .selector, "beforeend", '<div class="onesignal-bell-launcher-dialog"></div>'), c.addDomElement(
                                        this.dialog.selector, "beforeend",
                                        '<div class="onesignal-bell-launcher-dialog-body"></div>'), c.addDomElement(this.button
                                        .selector, "beforeEnd",
                                    ...
                                    ), [4, OneSignal.isPushNotificationsEnabled()]);
                            case 2:
                            ...
                            case 5:
                                if (r.sent(), "bottom-left" === this.options.position) c.addCssClass(this.container,
                                    "onesignal-bell-container-bottom-left"), c.addCssClass(this.launcher.selector,
                                    "onesignal-bell-launcher-bottom-left");
                                else {
                                    if ("bottom-right" !== this.options.position) throw new Error(
                                        "Invalid OneSignal notify button position " + this.options.position);
                                    c.addCssClass(this.container, "onesignal-bell-container-bottom-right"), c.addCssClass(this.launcher
                                        .selector, "onesignal-bell-launcher-bottom-right")
                                }
                                if ("default" === this.options.theme) c.addCssClass(this.launcher.selector,
                                    "onesignal-bell-launcher-theme-default");
                                else {
                                    if ("inverse" !== this.options.theme) throw new Error("Invalid OneSignal notify button theme " +
                                        this.options.theme);
                                    c.addCssClass(this.launcher.selector, "onesignal-bell-launcher-theme-inverse")
                                }
                                return this.applyOffsetIfSpecified(), this.setCustomColorsIfSpecified(), this.patchSafariSvgFilterBug(),
                                    g.default.info("Showing the notify button."), [4, (e ? this.launcher.inactivate() : c.nothing())
                                        .then(function() {
                                            return OneSignal.getSubscription()
                                        }).then(function(t) {
                                            return !e && t || null !== o.dialog.notificationIcons ? c.nothing() : u.default.getNotificationIcons()
                                                .then(function(e) {
                                            ...
                                            return c.isUsingSubscriptionWorkaround() && t && !0 !== n && !e && !0 === OneSignal
                                                .config.userConfig.autoRegister && !u.default.isHttpPromptAlreadyShown() ? (g.default
                                                    .debug("Not showing notify button because popover will be shown."), c.nothing()
                                                ) : o.launcher.show()
                                        }).then(function() {
                                            return c.delay(o.options.showBadgeAfter)
                                        }).then(function() {
                                            return o.options.prenotify && !e && OneSignal._isNewVisitor ? o.message.enqueue(o.text[
                                                "message.prenotify"]).then(function() {
                                                return o.badge.show()
                                            }) : c.nothing()
                                        }).then(function() {
                ...
                if (!(s.default.safari && Number(s.default.version) >= 9.1)) {
                    ...
                    this.graphic.setAttribute("style", "filter: " + e + "; -webkit-filter: " + e + ";"), this.badge.element.setAttribute("style",
                        "filter: " + t + "; -webkit-filter: " + t + ";"), this.dialog.element.setAttribute("style", "filter: " + n +
                        "; -webkit-filter: " + n + ";")
                }
                s.default.safari && this.badge.element.setAttribute("style", "display: none;")
            }, e.prototype.applyOffsetIfSpecified = function() {
                var e = this.options.offset;
                e && (this.launcher.element.style.cssText = "", e.bottom && (this.launcher.element.style.cssText += "bottom: " + e.bottom + ";"),
                    "bottom-right" === this.options.position ? e.right && (this.launcher.element.style.cssText += "right: " + e.right + ";") :
                    "bottom-left" === this.options.position && e.left && (this.launcher.element.style.cssText += "left: " + e.left + ";"))
                ...
                if (this.graphic.querySelector(".stroke").style.cssText = "", this.badge.element.style.cssText = "", e && (e.style.cssText = "", e.style
                        .cssText = ""), t && (t.style.cssText = ""), this.options.colors) {
                    var r = this.options.colors;
                    if (r["circle.background"] && (this.graphic.querySelector(".background").style.cssText += "fill: " + r["circle.background"]), r[
                            "circle.foreground"]) {
                    ...
                    r["badge.background"] && (this.badge.element.style.cssText += "background: " + r["badge.background"]), r["badge.bordercolor"] &&
                        (this.badge.element.style.cssText += "border-color: " + r["badge.bordercolor"]), r["badge.foreground"] && (this.badge.element
                            .style.cssText += "color: " + r["badge.foreground"]), e && (r["dialog.button.background"] && (this.dialog.element.querySelector(
                                "button.action").style.cssText += "background: " + r["dialog.button.background"]), r["dialog.button.foreground"] &&
                            (this.dialog.element.querySelector("button.action").style.cssText += "color: " + r["dialog.button.foreground"]), r[
                                "dialog.button.background.hovering"] && this.addCssToHead("onesignal-background-hover-style",
                                "#onesignal-bell-container.onesignal-reset .onesignal-bell-launcher .onesignal-bell-launcher-dialog button.action:hover { background: " +
                                r["dialog.button.background.hovering"] + " !important; }"), r["dialog.button.background.active"] && this.addCssToHead(
                                "onesignal-background-active-style",
                                "#onesignal-bell-container.onesignal-reset .onesignal-bell-launcher .onesignal-bell-launcher-dialog button.action:active { background: " +
                                r["dialog.button.background.active"] + " !important; }")), t && r["pulse.color"] && (this.button.element.querySelector(
            ...
            return e.prototype.getCache = function() {
                ...
                return r(this, void 0, void 0, function() {
                    ...
                    return o(this, function(t) {
                        switch (t.label) {
                            case 0:
                                return e = a.default.getOneSignalApiUrl().origin, [4, this.loadIfNew(0, new URL(e +
                                    "/sdks/OneSignalSDKStyles.css?v=" + u.default.getSdkStylesVersionHash()))];
                            case 1:
                                return [2, t.sent()]
                        }
                    })
                ...
                return r(this, void 0, void 0, function() {
                    return o(this, function(e) {
                        switch (e.label) {
                            case 0:
                                return [4, this.loadIfNew(1, new URL(
                        ...
                        switch (n.label) {
                            case 0:
                                return n.trys.push([0, 2, , 3]), [4, new Promise(function(n, i) {
                                    switch (e) {
                                        case 1:
                                            (r = document.createElement("script")).setAttribute("type",
                                                "text/javascript"), r.setAttribute("async", "async"), r.setAttribute(
                                                "src", t.toString());
                                            break;
                                        case 0:
                                            var r;
                                            (r = document.createElement("link")).setAttribute("rel", "stylesheet"), r.setAttribute(
                                                "href", t.toString())
                                    }
                ...
                return i(this, void 0, void 0, function() {
                    ...
                    return r(this, function(r) {
                        switch (r.label) {
                            ...
                            case 1:
                                if (r.sent() && !t.sessionManager.isFirstPageView()) return h.default.debug(
                            ...
                            case 4:
                                return e = r.sent(), t.sessionManager.incrementPageViewCount(), l.triggerNotificationPermissionChanged(),
                                    d.default.checkAndTriggerSubscriptionChanged(), [3, 6];
                            case 5:
                            ...
                            case 18:
                                return OneSignal.subscriptionPopup.message(OneSignal.POSTMAM_COMMANDS.FINISH_REMOTE_REGISTRATION, {
                                    ...
                                    !0 === e.data.progress ? (h.default.debug(
                                        "Got message from host page that remote reg. is in progress, closing popup."
                                    ), o && window.close()) : h.default.debug(
                                        "Got message from host page that remote reg. could not be finished.")
                                }), [3, 20];
                            case 19:
                                throw "undefined" != typeof OneSignal && (OneSignal._isRegisteringForPush = !1), new f.InvalidStateError(
                                    f.InvalidStateReason.UnsupportedEnvironment);
                            case 20:
    ...
    var i = function() {
        ...
        return e.put = function(t, n) {
            return void 0 === e.store[t] && (e.store[t] = [null, null]), e.store[t].push(n), e.store[t].length == e.LIMIT + 1 && e.store[t].shift(),
                e.store[t]
        }, e.get = function(t) {
    ...
    Object.defineProperty(t, "__esModule", {
            value: !0
        }), (i = t.PermissionPromptType || (t.PermissionPromptType = {}))[i.HttpsPermissionRequest = "HTTPS permission request"] =
        "HttpsPermissionRequest", i[i.FullscreenHttpPermissionMessage = "fullscreen HTTP permission message"] = "FullscreenHttpPermissionMessage", i[i.FullscreenHttpsPermissionMessage =
            "fullscreen HTTPS permission message"] = "FullscreenHttpsPermissionMessage", i[i.SlidedownPermissionMessage =
            "slidedown permission message"] = "SlidedownPermissionMessage", i[i.SubscriptionBell = "subscription bell"] = "SubscriptionBell"
}, function(e, t, n) {
    "use strict";
    Object.defineProperty(t, "__esModule", {
        value: !0
        ...
        c = function() {
            ...
            return e.prototype.open = function(e) {
                ...
                return new Promise(function(n) {
                    ...
                    if (!i) return null;
                    i.onerror = t.onDatabaseOpenError, i.onblocked = t.onDatabaseOpenBlocked, i.onupgradeneeded = t.onDatabaseUpgradeNeeded,
                        i.onsuccess = function() {
                            t.database = i.result, t.database.onerror = t.onDatabaseError, t.database.onversionchange = t.onDatabaseVersionChange,
                                n(t.database)
                        }
                })
                ...
                a.contains(t.message, "The operation failed for reasons unrelated to the database itself and not covered by any other error code") ||
                    a.contains(t.message, "A mutation operation was attempted on a database that did not allow mutations") ? u.default.warn(
                    ...
                    ) : u.default.warn("OneSignal: Fatal error opening IndexedDb database:", t)
    ...
    Object.defineProperty(t, "__esModule", {
            value: !0
        }), (i = t.BuildEnvironmentKind || (t.BuildEnvironmentKind = {})).Development = "Development", i.Staging = "Staging", i.Production =
        "Production"
}, function(e, t, n) {
    "use strict";
    (function(e) {
        ...
        var a = s(n(7)),
            ...
            y = function() {
                ...
                return Object.defineProperty(e, "VERSION", {
                    ...
                    self.addEventListener("push", e.onPushReceived), self.addEventListener("notificationclose", e.onNotificationClosed), self.addEventListener(
                            "notificationclick",
                            function(t) {
                                return t.waitUntil(e.onNotificationClicked(t))
                            }), self.addEventListener("install", e.onServiceWorkerInstalled), self.addEventListener("activate", e.onServiceWorkerActivated),
                    ...
                    return r(this, void 0, void 0, function() {
                        return o(this, function(e) {
                            switch (e.label) {
                                case 0:
                                    return self.location.search ? [2, self.location.search.match(/appId=([0-9a-z-]+)&?/i)[1]] :
                                        [3, 1];
                                case 1:
                    ...
                    e.workerMessenger.on(c.WorkerMessengerCommand.WorkerVersion, function(t) {
                        S.default.debug("[Service Worker] Received worker version message."), e.workerMessenger.broadcast(c.WorkerMessengerCommand
                            .WorkerVersion, u.default.version())
                        ...
                        return r(t, void 0, void 0, function() {
                            ...
                            return o(this, function(o) {
                                switch (o.label) {
                                    case 0:
                                        return t = n, S.default.debug("[Service Worker] Received subscribe message."), [
                                            4, (i = new d.default(t)).subscriptionManager.subscribe(0)
                                        ];
                                    case 1:
                                        return r = o.sent(), [4, i.subscriptionManager.registerSubscription(r)];
                                    case 2:
                                        return s = o.sent(), e.workerMessenger.broadcast(c.WorkerMessengerCommand.Subscribe,
                                            s.serialize()), [2]
                                }
                            })
                        })
                        ...
                        return r(t, void 0, void 0, function() {
                            ...
                            return o(this, function(o) {
                                switch (o.label) {
                                    case 0:
                                        return t = n, S.default.debug(
                                            "[Service Worker] Received subscribe new message."), [4, (i = new d.default(
                                            t)).subscriptionManager.subscribe(1)];
                                    case 1:
                                        return r = o.sent(), [4, i.subscriptionManager.registerSubscription(r)];
                                    case 2:
                                        return s = o.sent(), e.workerMessenger.broadcast(c.WorkerMessengerCommand.SubscribeNew,
                                            s.serialize()), [2]
                                }
                            })
                        })
                                ...
                                switch (o.label) {
                                    case 0:
                                        return S.default.debug(
                                            "[Service Worker] Received AMP subscription state message."), [4, self.registration
                                            .pushManager.getSubscription()
                                        ];
                                    case 1:
                                        return (t = o.sent()) ? [3, 2] : (e.workerMessenger.broadcast(c.WorkerMessengerCommand
                                            .AmpSubscriptionState, !1), [3, 5]);
                                    case 2:
                                        return [4, self.registration.pushManager.permissionState(t.options)];
                                    case 3:
                                        return n = o.sent(), [4, p.default.getSubscription()];
                                    case 4:
                                        i = o.sent().optedOut, r = !!t && "granted" === n && !0 !== i, e.workerMessenger
                                            .broadcast(c.WorkerMessengerCommand.AmpSubscriptionState, r), o.label = 5;
                                    case 5:
                                        return [2]
                                }
                            })
                        ...
                        return r(t, void 0, void 0, function() {
                            ...
                            return o(this, function(o) {
                                switch (o.label) {
                                    case 0:
                                        return S.default.debug("[Service Worker] Received AMP subscribe message."), [4,
                                            e.getAppId()
                                        ];
                                    case 1:
                                    ...
                                    case 3:
                                        return r = o.sent(), [4, i.subscriptionManager.registerSubscription(r)];
                                    case 4:
                                        return s = o.sent(), e.workerMessenger.broadcast(c.WorkerMessengerCommand.AmpSubscribe,
                                            s.deviceId), [2]
                                }
                            })
                        })
                        ...
                        return r(t, void 0, void 0, function() {
                            ...
                            return o(this, function(i) {
                                switch (i.label) {
                                    case 0:
                                        return S.default.debug("[Service Worker] Received AMP unsubscribe message."), [
                                            4, e.getAppId()
                                        ];
                                    case 1:
                                    ...
                                    case 3:
                                        return i.sent(), e.workerMessenger.broadcast(c.WorkerMessengerCommand.AmpUnsubscribe,
                                            null), [2]
                                }
                            })
                        })
                    ...
                    S.default.debug("Called %conPushReceived(" + JSON.stringify(t, null, 4) + "):", h.getConsoleStyle("code"), t), t.waitUntil(
                        e.parseOrFetchNotifications(t).then(function(t) {
                            if (!t || 0 == t.length) return S.default.debug(
                                "Because no notifications were retrieved, we'll display the last known notification, so long as it isn't the welcome notification."
                            ...
                            for (var n = [], i = 0, r = t; i < r.length; i++) {
                                ...
                                n.push(function(t) {
                                    return e.displayNotification(t).then(function() {
                                        ...
                                        return e.workerMessenger.broadcast(c.WorkerMessengerCommand.NotificationDisplayed,
                                            t).catch(function(e) {
                                            return S.default.error(e)
                                        })
                                    }).then(function() {
                            ...
                            return S.default.debug("Failed to display a notification:", t), e.UNSUBSCRIBED_FROM_NOTIFICATIONS ? void S.default
                                .debug("Because we have just unsubscribed from notifications, we will not show anything.") : (S.default
                                    .debug(
                        ...
                        return o(this, function(o) {
                            switch (o.label) {
                                ...
                                case 3:
                                    ...
                                    }), S.default.debug("Executing " + e + " webhook " + (i ? "with" : "without") +
                                        " CORS %cPOST " + r, h.getConsoleStyle("code"), ":", s), [4, fetch(r, a)]) : [3, 5];
                                case 4:
                                    return [2, o.sent()];
                                case 5:
                                    return [2]
                                ...
                                case 1:
                                    for (e = o.sent(), t = [], n = 0, i = e; n < i.length; n++) {
                                        if ((r = i[n]).frameType && "nested" === r.frameType) {
                                            if (!h.contains(r.url, l.default.getOneSignalApiUrl().host) && !h.contains(r.url,
                                                    ".os.tc")) continue;
                    ...
                    try {
                        var t = new URL(e);
                        return "localhost" === t.hostname || -1 !== t.hostname.indexOf("192.168") || "127.0.0.1" === t.hostname || "https:" ===
                            t.protocol ? e : "i0.wp.com" === t.hostname || "i1.wp.com" === t.hostname || "i2.wp.com" === t.hostname ||
                            "i3.wp.com" === t.hostname ? "https://" + t.hostname + t.pathname : "https://i0.wp.com/" + (t.host + t.pathname)
                    } catch (e) {}
                }, e.ensureNotificationResourcesHttps = function(t) {
                    if (t && (t.icon && (t.icon = e.ensureImageResourceHttps(t.icon)), t.image && (t.image = e.ensureImageResourceHttps(t.image)),
                    ...
                    return r(this, void 0, void 0, function() {
                        ...
                        return o(this, function(o) {
                            switch (o.label) {
                                case 0:
                                    return S.default.debug("Called %cdisplayNotification(" + JSON.stringify(t, null, 4) + "):",
                                        h.getConsoleStyle("code"), t), [4, e._getTitle()];
                                case 1:
                                ...
                                case 4:
                                    return u = o.sent(), t.heading = t.heading ? t.heading : r, t.icon = t.icon ? t.icon : s ||
                                        void 0, (c = {}).tag = t.tag || u, c.persistNotification = "force" === a || a, n || (n = {}),
                                        t = i({}, t, n), e.ensureNotificationResourcesHttps(t), l = {
                                            body: t.content,
                                            icon: t.icon,
                                            image: t.image,
                                            data: t,
                                            ...
                                            badge: t.badge,
                                            vibrate: t.vibrate
                                        }, l = e.filterNotificationOptions(l, "force" === a), [2, self.registration.showNotification(
                                            t.heading, l)]
                            }
                        })
                    })
                            ...
                            switch (o.label) {
                                ...
                                case 1:
                                    if ((n = o.sent().defaultNotificationUrl) && (t = n), e.action)
                                        for (i = 0, r = e.buttons; i < r.length; i++)(s = r[i]).action === e.action && s.url &&
                                            "" !== s.url && (t = s.url);
                    ...
                    return r(this, void 0, void 0, function() {
                        ...
                        return o(this, function(o) {
                            switch (o.label) {
                                case 0:
                                    return S.default.debug("Called %conNotificationClicked(" + JSON.stringify(t, null, 4) +
                                            "):", h.getConsoleStyle("code"), t), t.notification.close(), n = t.notification.data,
                                        t.action && (n.action = t.action), i = "exact", r = "navigate", [4, p.default.get(
                                            "Options", "notificationClickHandlerMatch")];
                                case 1:
                                    return (s = o.sent()) && (i = s), [4, this.database.get("Options",
                                ...
                                case 5:
                                    return b < m.length ? (v = m[b], y = v.url, v.isSubdomainIframe ? [4, p.default.get(
                                        "Options", "lastKnownHostUrl")] : [3, 8]) : [3, 37];
                                case 6:
                                ...
                                case 8:
                                    ...
                                    if (!(v.isSubdomainIframe && y === l || !v.isSubdomainIframe && v.url === l || "focus" ===
                                            r && O === _)) return [3, 13];
                                ...
                                case 13:
                                    ...
                                    o.label = 14;
                                case 14:
                                    return o.trys.push([14, 16, , 17]), S.default.debug(
                                        "Client is subdomain iFrame. Attempting to focus() client."), [4, v.focus()];
                                case 15:
                                    return o.sent(), [3, 17];
                                case 16:
                                    return P = o.sent(), S.default.error("Failed to focus:", v, P), [3, 17];
                                case 17:
                                    return d ? (S.default.debug("Redirecting HTTP site to " + l + "."), [4, p.default.put(
                                        "NotificationOpened", {
                                            url: l,
                                            data: n,
                                            timestamp: Date.now()
                                ...
                                case 18:
                                    return o.sent(), e.workerMessenger.unicast(c.WorkerMessengerCommand.RedirectPage, l, v), [3,
                                        20
                                    ];
                                case 19:
                                ...
                                case 21:
                                    ...
                                    o.label = 22;
                                case 22:
                                    return o.trys.push([22, 24, , 25]), S.default.debug(
                                        "Client is standard HTTPS site. Attempting to focus() client."), [4, v.focus()];
                                case 23:
                                    return o.sent(), [3, 25];
                                case 24:
                                    return I = o.sent(), S.default.error("Failed to focus:", v, I), [3, 25];
                                case 25:
                                    return o.trys.push([25, 30, , 31]), d ? (S.default.debug("Redirecting HTTPS site to (" + l +
                                        ")."), [4, p.default.put("NotificationOpened", {
                                        url: l,
                                        data: n,
                                        timestamp: Date.now()
                                    })]) : [3, 28];
                    ...
                    S.default.info("%cOneSignal Service Worker activated (version " + u.default.version() + ", " + l.default.getWindowEnv().toString() +
                        " environment).", h.getConsoleStyle("bold")), e.waitUntil(self.clients.claim())
                    ...
                    return r(this, void 0, void 0, function() {
                        ...
                        return o(this, function(o) {
                            switch (o.label) {
                                case 0:
                                    return S.default.debug("Called %conPushSubscriptionChange(" + JSON.stringify(t, null, 4) +
                                        "):", h.getConsoleStyle("code"), t), [4, e.getAppId()];
                                case 1:
                                ...
                                case 3:
                                    return a = o.sent().deviceId, (s = !!a) || !t.oldSubscription ? [3, 7] : [4, f.default.getUserIdFromSubscriptionIdentifier(
                                        n, v.PushDeviceRecord.prototype.getDeliveryPlatform(), t.oldSubscription.endpoint
                                    )];
                                case 4:
                                ...
                                case 6:
                                    o.sent(), o.label = 7;
                                case 7:
                                    return s = !!a, (l = t.newSubscription) ? (c = b.RawPushSubscription.setFromW3cSubscription(
                                        l), [3, 11]) : [3, 8];
                                case 8:
                                ...
                                case 15:
                                    return "granted" !== o.sent() ? y = m.SubscriptionStateKind.PermissionRevoked : c || (y = m
                                        .SubscriptionStateKind.PushSubscriptionRevoked), [4, r.subscriptionManager.registerSubscription(
                                        c, y)];
                                case 16:
                                    o.sent(), o.label = 17;
                                case 17:
                    ...
                    return t.data ? e.isValidPushPayload(t.data) ? (S.default.debug("Received a valid encrypted push payload."), Promise.resolve(
                        [t.data.json()])) : Promise.reject("Unexpected push message payload received: " + t.data.text()) : e.retrieveNotifications()
                }, e.isValidPushPayload = function(e) {
                    try {
                        var t = e.json();
                        return !!(t && t.custom && t.custom.i && h.isValidUuid(t.custom.i)) || (S.default.debug(
                            "isValidPushPayload: Valid JSON but missing notification UUID:", t), !1)
                    } catch (e) {
                    ...
                    return new Promise(function(t) {
                        ...
                        p.default.get("Ids", "userId").then(function(t) {
                            return t ? (S.default.debug("Legacy push signal received, retrieving contents from players/" + t +
                                "/chromeweb_notification"), f.default.get("players/" + t + "/chromeweb_notification")) : (S
                                .default.debug("Tried to get notification contents, but IndexedDB is missing user ID info."),
                                Promise.all([e.getAppId(), self.registration.pushManager.getSubscription().then(function(e) {
                                    return e.endpoint
                                })]).then(function(e) {
                                    var t = e[0],
                                        n = e[1],
                                    ...
                                    return f.default.getUserIdFromSubscriptionIdentifier(t, i, n).then(function(e) {
                                        return e ? (S.default.debug("Recovered OneSignal user ID:", e), Promise
                                            .all([p.default.put("Ids", {
                                                type: "userId",
                                                id: e
                                            }), p.default.put("Ids", {
                                                type: "registrationId",
                                                id: n.replace(new RegExp(
                                                    "^(https://android.googleapis.com/gcm/send/|https://updates.push.services.mozilla.com/push/)"
                                                ), "")
                                            })]).then(function() {
                                                return S.default.debug(
                                                    "Attempting to retrieve the notification again now with a recovered user ID."
                                                ), f.default.get("players/" + e +
                                                    "/chromeweb_notification")
                                            })) : Promise.reject(
                                            "Recovered user ID was null. Unsubscribing from push notifications."
                                        )
                                    })
                                }).catch(function(t) {
                                    return S.default.debug("Unsuccessfully attempted to recover OneSignal user ID:", t),
                                        self.registration.pushManager.getSubscription().then(function(e) {
                                            return e.unsubscribe()
                                        }).then(function(t) {
                                            S.default.debug("Unsubscribed from push notifications result:", t), e.UNSUBSCRIBED_FROM_NOTIFICATIONS = !
                                                0
                                        })
                                }))
                        }).then(function(e) {
                            for (var i = 0; i < e.length; i++) n.push(JSON.parse(e[i]));
                            0 == n.length && S.default.warn(
                                "OneSignal Worker: Received a GCM push signal, but there were no messages to retrieve. Are you using the wrong API URL?",
                                l.default.getOneSignalApiUrl().toString()), t(n)
                        })
                    })
                }, e
            }();
        t.ServiceWorker = y, "undefined" == typeof self && void 0 !== e ? e.OneSignalWorker = y : self.OneSignalWorker = y, "undefined" != typeof self &&
            y.run()
    }).call(this, n(34))
}, function(e, t, n) {
    "use strict";
    ...
    Object.defineProperty(t, "__esModule", {
            value: !0
        }), (i = t.ConfigIntegrationKind || (t.ConfigIntegrationKind = {})).TypicalSite = "typical", i.WordPress = "wordpress", i.Shopify = "shopify",
        i.Blogger = "blogger", i.Magento = "magento", i.Drupal = "drupal", i.SquareSpace = "squarespace", i.Joomla = "joomla", i.Weebly = "weebly", i.Wix =
        "wix", i.Custom = "custom", (r = t.NotificationClickMatchBehavior || (t.NotificationClickMatchBehavior = {})).Exact = "exact", r.Origin =
        "origin", (o = t.NotificationClickActionBehavior || (t.NotificationClickActionBehavior = {})).Navigate = "navigate", o.Focus = "focus"
}, function(e, t, n) {
    "use strict";
    var i = this && this.__awaiter || function(e, t, n, i) {
            return new(n || (n = Promise))(function(r, o) {
            ...
            return Object.defineProperty(e, "STORED_PERMISSION_KEY", {
                ...
                return i(this, void 0, void 0, function() {
                    ...
                    return r(this, function(r) {
                        switch (r.label) {
                            case 0:
                                return t = s.redetectBrowserUserAgent(), (n = !t.safari && !t.firefox && e === l.NotificationPermission
                                        .Denied) ? (i = this.isCurrentFrameContextCrossOrigin()) ? [3, 2] : [4, d.default.isFrameContextInsecure()] :
                                    [3, 3];
                            case 1:
                                i = r.sent(), r.label = 2;
                            case 2:
    ...
    var r = i(n(0)),
        ...
        a = function() {
            ...
            return e.prototype.getPageViewCount = function() {
                ...
                try {
                    sessionStorage.setItem(e.SESSION_STORAGE_KEY_NAME, t.toString()), r.default.getWindowEnv() === o.WindowEnvironmentKind.OneSignalSubscriptionPopup &&
                        OneSignal.subscriptionPopup && OneSignal.subscriptionPopup.message(OneSignal.POSTMAM_COMMANDS.SET_SESSION_COUNT)
                } catch (e) {}
    ...
    var r = i(n(0)),
        o = function() {
            ...
            return Object.defineProperty(e.prototype, "PUBLISHER_ID", {
                ...
                return !!this.context.appConfig.subdomain ? new URL("https://" + this.context.appConfig.subdomain + ".os.tc") : new URL(r.default.getOneSignalApiUrl()
                    .origin)
            }, e.prototype.install = function() {
                if (window.top === window) {
                    var e = this.getFrameOrigin();
                    this.isFeatureEnabled ? (e.pathname = "/webPushAnalytics", e.search = "sync=true&appId=" + this.PUBLISHER_ID) : e.pathname =
                        "/webPushAnalytics";
            ...
            return e.isSafari = function() {
                    ...
                    return r(this, function(r) {
                        switch (r.label) {
                            ...
                            case 3:
                                return [4, OneSignal.getNotificationPermission()];
                            case 4:
                                if (r.sent() === h.NotificationPermission.Denied) throw new u.default(c.PushPermissionNotGrantedErrorReason
                                    .Blocked);
                ...
                return i(this, void 0, void 0, function() {
                    ...
                    return r(this, function(r) {
                        switch (r.label) {
                            case 0:
                                return t && (t = g.RawPushSubscription.deserialize(t)), (i = _.PushDeviceRecord.createFromPushSubscription(
                                        this.config.appId, t, n)).appId = this.config.appId, i.subscriptionState = b.SubscriptionStateKind
                                    .Subscribed, [4, this.isAlreadyRegisteredWithOneSignal()];
                            case 1:
                                return r.sent() ? [4, S.default.getSubscription()] : [3, 6];
                            case 2:
                                return s = r.sent().deviceId, t && !t.isNewSubscription() ? [3, 4] : [4, v.default.updateUserSession(
                                    s, i)];
                            case 3:
                            ...
                            case 7:
                                a = r.sent(), o = a, I.default.info("Subscribed to web push and registered with OneSignal:", i), r.label =
                                    8;
                            case 8:
                            ...
                            case 10:
                                return (u = r.sent()).deviceId = o, u.optedOut = !1, t ? e.isSafari() ? u.subscriptionToken = t.safariDeviceToken :
                                    u.subscriptionToken = t.w3cEndpoint.toString() : u.subscriptionToken = null, [4, S.default.setSubscription(
                                        u)];
                            case 11:
                                return r.sent(), y.default.getWindowEnv() !== m.WindowEnvironmentKind.ServiceWorker && p.default.trigger(
                                    OneSignal.EVENTS.REGISTERED), "undefined" != typeof OneSignal && (OneSignal._sessionInitAlreadyRunning = !
                                    1), [2, u]
                        }
                    })
                })
                    ...
                    return r(this, function(n) {
                        switch (n.label) {
                            case 0:
                                ...
                                throw new w.default;
                            case 1:
                                return 1 !== e ? [3, 7] : y.default.getWindowEnv() !== m.WindowEnvironmentKind.ServiceWorker ? [3,
                                    5
                                ] : [4, S.default.getSubscription()];
                            case 2:
                ...
                return i(this, void 0, void 0, function() {
                    ...
                    return r(this, function(i) {
                        switch (i.label) {
                            case 0:
                                if (e = new g.RawPushSubscription, !this.config.safariWebId) throw new l.SdkInitError(l.SdkInitErrorKind
                                    .MissingSafariWebId);
                                return t = window.safari.pushNotification.permission(this.config.safariWebId).deviceToken, e.existingSafariDeviceToken =
                                    t, t || p.default.trigger(OneSignal.EVENTS.PERMISSION_PROMPT_DISPLAYED), [4, this.subscribeSafariPromptPermission()];
                            case 1:
                                if (n = i.sent(), M.triggerNotificationPermissionChanged(), !n) throw new d.default(f.SubscriptionErrorReason
                                    .InvalidSafariSetup);
                ...
                return i(this, void 0, void 0, function() {
                    ...
                    return r(this, function(i) {
                        switch (i.label) {
                            case 0:
                                return y.default.getWindowEnv() === m.WindowEnvironmentKind.ServiceWorker || window.Notification.permission !==
                                    h.NotificationPermission.Default ? [3, 2] : (p.default.trigger(OneSignal.EVENTS.PERMISSION_PROMPT_DISPLAYED), [
                                        4, this.requestPresubscribeNotificationPermission()
                                    ]);
                            case 1:
                                switch ((t = i.sent()) === h.NotificationPermission.Default && M.triggerNotificationPermissionChanged(!
                                    0), t) {
                                    case h.NotificationPermission.Default:
                                        throw I.default.debug(
                                                "Exiting subscription and not registering worker because the permission was dismissed."
                                            ), OneSignal._sessionInitAlreadyRunning = !1, OneSignal._isRegisteringForPush = !1, new u
                                            .default(c.PushPermissionNotGrantedErrorReason.Dismissed);
                                    case h.NotificationPermission.Denied:
                                        throw I.default.debug(
                                                "Exiting subscription and not registering worker because the permission was blocked."
                                            ), OneSignal._sessionInitAlreadyRunning = !1, OneSignal._isRegisteringForPush = !1, new u
                                            .default(c.PushPermissionNotGrantedErrorReason.Blocked)
                                }
                                i.label = 2;
                            case 2:
                            ...
                            case 4:
                                i.sent(), i.label = 5;
                            case 5:
                                return I.default.debug("Waiting for the service worker to activate..."), [4, navigator.serviceWorker
                                    .ready
                                ];
                            case 6:
                                return n = i.sent(), I.default.debug("Service worker is ready to continue subscribing."), [4, this.subscribeFcmVapidOrLegacyKey(
                                    n.pushManager, e)];
                            case 7:
                                return [2, i.sent()]
                        }
                ...
                return i(this, void 0, void 0, function() {
                    ...
                    return r(this, function(n) {
                        switch (n.label) {
                            case 0:
                                if (!self.registration.active && !s.default.firefox) throw new a.InvalidStateError(a.InvalidStateReason
                ...
                var e = void 0;
                return (e = s.default.firefox ? this.config.onesignalVapidPublicKey : this.config.vapidPublicKey) ? O.base64ToUint8Array(e).buffer :
                    void 0
                    ...
                    return r(this, function(r) {
                        switch (r.label) {
                            ...
                            case 1:
                                ...
                                return [3, 9];
                            case 2:
                                return o && o.options ? (I.default.debug(
                                    "[Subscription Manager] An existing push subscription exists and options is not null. Using existing options to resubscribe."
                                ), n = o.options, s = !1, [3, 5]) : [3, 3];
                            case 3:
                                return !o || o.options ? [3, 5] : (I.default.debug(
                            ...
                            case 5:
                                return [3, 9];
                            case 6:
                                return o ? (I.default.debug("[Subscription Manager] Unsubscribing existing push subscription."), [4,
                                    o.unsubscribe()
                                ]) : [3, 8];
                            case 7:
                                r.sent(), r.label = 8;
                            case 8:
                                return s = !0, [3, 9];
                            case 9:
                                return I.default.debug("[Subscription Manager] Subscribing to web push with these options:", n), [4,
                                    e.subscribe(n)
                                ];
                            case 10:
                                return i = r.sent(), s ? [4, S.default.getSubscription()] : [3, 13];
                            case 11:
                                return (a = r.sent()).createdAt = (new Date).getTime(), a.expirationTime = i.expirationTime, [4, S.default
                                    .setSubscription(a)
                                ];
                            case 12:
                                r.sent(), r.label = 13;
                            case 13:
                                return u = g.RawPushSubscription.setFromW3cSubscription(i), o && (u.existingW3cPushSubscription = g
                                    .RawPushSubscription.setFromW3cSubscription(o)), [2, u]
                        }
                    })
                })
                    ...
                    return r(this, function(r) {
                        switch (r.label) {
                            case 0:
                                return [4, this.context.serviceWorkerManager.getActiveState()];
                            case 1:
                                return (e = r.sent()) !== E.ServiceWorkerActiveState.WorkerA && e !== E.ServiceWorkerActiveState.WorkerB ?
                                    [2, !1] : [4, navigator.serviceWorker.getRegistration()];
                            case 2:
                                return [4, r.sent().pushManager.getSubscription()];
                            case 3:
                                return (t = r.sent()) && t.expirationTime ? [4, S.default.getSubscription()] : [2, !1];
                            case 4:
                                return (n = r.sent().createdAt) || (i = 31536e6, n = (new Date).getTime() + i), o = n + (t.expirationTime -
                                    n) / 2, [2, t.expirationTime && ((new Date).getTime() >= t.expirationTime || (new Date).getTime() >=
                                    o)]
                        }
                    })
                })
                    ...
                    return r(this, function(r) {
                        switch (r.label) {
                            case 0:
                                return [4, S.default.getSubscription()];
                            case 1:
                                return t = r.sent(), n = t.deviceId, t.subscriptionToken, i = t.optedOut, e.isSafari() ? (o =
                                    window.safari.pushNotification.permission(this.config.safariWebId), [2, {
                            ...
                            case 3:
                                return a = r.sent(), [4, this.context.permissionManager.getNotificationPermission(this.context.appConfig
                                    .safariWebId)];
                            case 4:
                                return u = r.sent(), c = s === E.ServiceWorkerActiveState.WorkerA || s === E.ServiceWorkerActiveState
                                    .WorkerB, a ? [4, a.pushManager.getSubscription()] : [2, {
                                        subscribed: !1,
                                        optedOut: i
                                    }];
                            case 5:
                    ...
                    return r(this, function(r) {
                        switch (r.label) {
                            case 0:
                                return [4, S.default.getSubscription()];
                            case 1:
                                return e = r.sent(), t = e.deviceId, n = e.subscriptionToken, i = e.optedOut, [4, this.context.permissionManager
                                    .getNotificationPermission(this.context.appConfig.safariWebId)
                                ];
                            case 2:
                                return o = r.sent(), [2, {
            ...
            return e.prototype.initialize = function() {
                return r(this, void 0, void 0, function() {
                    ...
                    return o(this, function(r) {
                        switch (r.label) {
                            case 0:
                                return (window.opener || window.parent) == window ? (document.write(
                                ...
                                ), [2, Promise.resolve()]) : ((e = i({}, this.options)).appId = e.appId, e.subdomainName = e.subdomain,
                                    e.origin = e.origin, OneSignal.config = e || {}, [4, (new c.default).getAppConfig(e)]);
                            case 1:
                                return t = r.sent(), OneSignal.context = new u.default(t), OneSignal.context.workerMessenger.listen(!
                                    0), OneSignal.initialized = !0, this.loadPromise = {}, this.loadPromise.promise = new Promise(
                                    function(e, t) {
                ...
                return r(this, void 0, void 0, function() {
                    ...
                    return o(this, function(n) {
                        switch (n.label) {
                            ...
                            case 1:
                                return e = n.sent(), t = opener || parent, e ? t && window.close() : a.default.registerForPush(), [
                                    2
                                ]
                        }
                    })
    ...
    var r = n(1),
        ...
        a = function() {
            function e(e, t, n, i, r, o, s) {
                void 0 === i && (i = "shown"), void 0 === r && (r = ["opacity", "transform"]), void 0 === s && (s = 500), this.selector = e, this.showClass =
                    t, this.hideClass = n, this.state = i, this.targetTransitionEvents = r, this.nestedContentSelector = o, this.transitionCheckTimeout =
                    s
            }
            return e.prototype.show = function() {
                var t = this;
                return this.hidden ? new Promise(function(n) {
                    if (t.state = "showing", o.default.trigger(e.EVENTS.SHOWING, t), t.hideClass && r.removeCssClass(t.element, t.hideClass),
                        t.showClass && r.addCssClass(t.element, t.showClass), 0 == t.targetTransitionEvents.length) return n(t);
                    ...
                    r.once(t.element, "transitionend", function(s, a) {
                        if (s.target === t.element && r.contains(t.targetTransitionEvents, s.propertyName)) return clearTimeout(i),
                            a(), t.state = "shown", o.default.trigger(e.EVENTS.SHOWN, t), n(t)
                    }, !0)
                }) : Promise.resolve(this)
            }, e.prototype.hide = function() {
                var t = this;
                return this.shown ? new Promise(function(n) {
                    if (t.state = "hiding", o.default.trigger(e.EVENTS.HIDING, t), t.showClass && r.removeCssClass(t.element, t.showClass),
                        t.hideClass && r.addCssClass(t.element, t.hideClass), 0 == t.targetTransitionEvents.length) return n(t);
                    r.once(t.element, "transitionend", function(i, a) {
                        var u = setTimeout(function() {
                            s.default.debug("Element did not completely hide (state: " + t.state + ").")
                        }, t.transitionCheckTimeout);
                        if (i.target === t.element && r.contains(t.targetTransitionEvents, i.propertyName)) return clearTimeout(u),
                            a(), t.state = "hidden", o.default.trigger(e.EVENTS.HIDDEN, t), n(t)
                    }, !0)
                }) : Promise.resolve(this)
                ...
                set: function(e) {
                    this.nestedContentSelector ? this.element.querySelector(this.nestedContentSelector).innerHTML = e : this.element.innerHTML =
                        e
                },
                enumerable: !0,
                configurable: !0
    ...
    var a = s(n(5)),
        ...
        d = function(e) {
            function t(t, n, i, r, o, s, a, u, c) {
                ...
                return l.selector = t, l.showClass = n, l.hideClass = i, l.activeClass = r, l.inactiveClass = o, l.state = s, l.activeState = a, l.targetTransitionEvents =
                    u, l.nestedContentSelector = c, l
            }
            return r(t, e), t.prototype.activate = function() {
                var e = this;
                return this.inactive && this.shown ? new Promise(function(n) {
                    if (e.activeState = "activating", a.default.trigger(t.EVENTS.ACTIVATING, e), e.inactiveClass && u.removeCssClass(e.element,
                            e.inactiveClass), e.activeClass && u.addCssClass(e.element, e.activeClass), !e.shown) return l.default.debug(
                        "Ending activate() transition (alternative)."), e.activeState = "active", a.default.trigger(t.EVENTS.ACTIVE,
                        e), n(e);
                    ...
                    u.once(e.element, "transitionend", function(r, o) {
                        if (r.target === e.element && u.contains(e.targetTransitionEvents, r.propertyName)) return clearTimeout(i),
                            o(), e.activeState = "active", a.default.trigger(t.EVENTS.ACTIVE, e), n(e)
                    }, !0)
                }) : Promise.resolve(this)
            }, t.prototype.inactivate = function() {
                var e = this;
                return this.active ? new Promise(function(n) {
                    if (e.activeState = "inactivating", a.default.trigger(t.EVENTS.INACTIVATING, e), e.activeClass && u.removeCssClass(e.element,
                            e.activeClass), e.inactiveClass && u.addCssClass(e.element, e.inactiveClass), !e.shown) return e.activeState =
                        "inactive", a.default.trigger(t.EVENTS.INACTIVE, e), n(e);
                    if (0 == e.targetTransitionEvents.length) return n(e);
                    var i = setTimeout(function() {
                    ...
                    u.once(e.element, "transitionend", function(r, o) {
                        if (r.target === e.element && u.contains(e.targetTransitionEvents, r.propertyName)) return clearTimeout(i),
                            o(), e.activeState = "inactive", a.default.trigger(t.EVENTS.INACTIVE, e), n(e)
                    }, !0)
                }) : Promise.resolve(this)
    ...
    e.exports = function(e, t, r) {
        ...
        return window[u] = function(e) {
                p(), r && r(null, e)
            }, e = (e += (~e.indexOf("?") ? "&" : "?") + c + "=" + d(u)).replace("?&", "?"), (o = document.createElement("script")).src = e, f.parentNode
            .insertBefore(o, f),
            function() {
                window[u] && p()
            }
            ...
            return e.onNotificationPermissionChange = function() {
                ...
                return i(this, void 0, void 0, function() {
                    ...
                    return r(this, function(r) {
                        switch (r.label) {
                            case 0:
                                return l.logMethodCall("checkAndTriggerSubscriptionChanged"), [4, OneSignal.context.subscriptionManager
                                    .getSubscriptionState()
                                ];
                            case 1:
                                return t = r.sent(), [4, c.default.getAppState()];
                            case 2:
                                return n = r.sent(), i = n.lastKnownPushEnabled, null === i || t.subscribed !== i ? (d.default.info(
                                    "The user's subscription state changed from " + (null === i ? "(not stored)" : i) +
                                    " ⟶ " + t.subscribed), n.lastKnownPushEnabled = t.subscribed, [4, c.default.setAppState(
                                    n)]) : [2];
                            case 3:
                ...
                return i(this, void 0, void 0, function() {
                    return r(this, function(n) {
                        return e.onSubscriptionChanged_showWelcomeNotification(t), e.onSubscriptionChanged_evaluateNotifyButtonDisplayPredicate(
                            t), [2]
                    })
                })
                ...
                return i(this, void 0, void 0, function() {
                    ...
                    return r(this, function(r) {
                        switch (r.label) {
                            case 0:
                                return OneSignal.__doNotShowWelcomeNotification ? (d.default.debug(
                                        "Not showing welcome notification because user has previously subscribed."), [2]) : !0 !==
                                    e ? [3, 3] : [4, c.default.getSubscription()];
                            case 1:
                                return t = r.sent().deviceId, [4, c.default.getAppConfig()];
                            case 2:
                                n = r.sent().appId, i = OneSignal.config.userConfig.welcomeNotification, o = void 0 !== i && !0 ===
                                    i.disable, a = void 0 !== i && void 0 !== i.title && null !== i.title ? i.title : "", f = void 0 !==
                                    i && void 0 !== i.message && null !== i.message && i.message.length > 0 ? i.message :
                                    "Thanks for subscribing!", p = new URL(location.href).origin + "?_osp=do_not_open", h = i && i.url &&
                                    i.url.length > 0 ? i.url : p, a = l.decodeHtmlEntities(a), f = l.decodeHtmlEntities(f), o || (d
                ...
                return i(this, void 0, void 0, function() {
                    ...
                    return r(this, function(t) {
                        switch (t.label) {
                            case 0:
                                return (e = OneSignal.config.userConfig.notifyButton.displayPredicate) && "function" == typeof e &&
                                    OneSignal.notifyButton ? [4, e()] : [3, 2];
                            case 1:
                                !1 !== t.sent() ? (d.default.debug("Showing notify button because display predicate returned true."),
                                    OneSignal.notifyButton.launcher.show()) : (d.default.debug(
                                        "Hiding notify button because display predicate returned false."), OneSignal.notifyButton
                                    .launcher.hide()), t.label = 2;
                            case 2:
                                return [2]
                        }
                    })
                ...
                return void 0 === e && (e = document.URL), i(this, void 0, void 0, function() {
                        ...
                        return i(this, void 0, void 0, function() {
                            ...
                            return r(this, function(r) {
                                switch (r.label) {
                                    ...
                                    case 1:
                                        return (t = r.sent()).clickedNotifications[e.url] = null, [4, c.default.setAppState(
                                            t)];
                                    case 2:
                                        return r.sent(), n = e.data, (i = e.timestamp) && (Date.now() - i) / 1e3 / 60 > 5 ?
                                            [2] : (s.default.trigger(OneSignal.EVENTS.NOTIFICATION_CLICKED, n), [2])
                                }
                            })
                        })
                    }
                    ...
                    return r(this, function(i) {
                        switch (i.label) {
                            ...
                            case 3:
                                return o < a.length ? (u = a[o], new URL(u).origin !== location.origin ? [3, 5] : [4, t(n.clickedNotifications[
                                    u])]) : [3, 6];
                            case 4:
                                i.sent(), i.label = 5;
                            case 5:
                            ...
                            case 8:
                                return i.sent(), [3, 11];
                            case 9:
                                return l || !e.endsWith("/") ? [3, 11] : (d = e.substring(0, e.length - 1), (l = n.clickedNotifications[
                                    d]) ? [4, t(l)] : [3, 11]);
                            case 10:
                                i.sent(), i.label = 11;
                            case 11:
                        ...
                        switch (i.label) {
                            case 0:
                                return l.isUsingSubscriptionWorkaround() ? [4, new Promise(function(e, t) {
                                    OneSignal.proxyFrameHost.message(OneSignal.POSTMAM_COMMANDS.MARK_PROMPT_DISMISSED, {},
                                        function(n) {
                                            n.data === OneSignal.POSTMAM_COMMANDS.REMOTE_OPERATION_COMPLETE ? e() :
                                                t()
                                        })
                                })] : [3, 2];
                            case 1:
                            ...
                            case 3:
                                return (e = i.sent()) || (e = 0), l.isUsingSubscriptionWorkaround() || (e += 1), t = 3, 2 == e ? t =
                                    7 : e > 2 && (t = 30), c.default.debug("(" + s.default.getWindowEnv().toString() +
                                        ") OneSignal: User dismissed the native notification prompt; reprompt after " + t +
                                        " days."), [4, a.default.put("Options", {
                                        key: "promptDismissCount",
                                        value: e
                                    })];
                            case 4:
                                return i.sent(), n = 24 * t * 60, [2, u.default.setItem("onesignal-notification-prompt",
                                    "dismissed", n)]
                        }
                    })
                })
    ...
    var s = n(1),
        ...
        l = function(e) {
            function t(t) {
                var n = e.call(this, ".onesignal-bell-launcher-message", "onesignal-bell-launcher-message-opened", null, "hidden", ["opacity",
                    "transform"
                ], ".onesignal-bell-launcher-message-body") || this;
            ...
            return r(t, e), Object.defineProperty(t, "TIMEOUT", {
                ...
                var i = this;
                return void 0 === n && (n = 0), c.default.debug("Calling %cdisplay(" + e + ", " + t + ", " + n + ").", s.getConsoleStyle("code")),
                    (this.shown ? this.hide() : s.nothing()).then(function() {
                ...
                return this.bell.state === u.default.STATES.UNSUBSCRIBED ? this.bell.text["tip.state.unsubscribed"] : this.bell.state === u.default
                    .STATES.SUBSCRIBED ? this.bell.text["tip.state.subscribed"] : this.bell.state === u.default.STATES.BLOCKED ? this.bell.text[
                        "tip.state.blocked"] : void 0
            ...
            return e.storeInitialValues = function() {
                ...
                return r(this, void 0, void 0, function() {
                    ...
                    return o(this, function(o) {
                        switch (o.label) {
                            case 0:
                                return e = OneSignal.context, T.default.debug("Checking subscription expiration..."), [4, e.subscriptionManager
                                    .isSubscriptionExpiring()
                                ];
                            case 1:
                                return o.sent() ? [4, h.default.getIntegration()] : (T.default.debug(
                                    "Subscription is not considered expired."), [2]);
                            case 2:
                                switch (t = o.sent(), n = h.default.getWindowEnv(), T.default.debug(
                                    "Subscription is considered expiring. Current Integration:", t), t) {
                            ...
                            case 12:
                                return o.sent(), T.default.debug(
                                    "Unsubscribed expiring HTTP subscription by removing registration ID."), [3, 13];
                            case 13:
                                return [2]
                        }
                    })
                ...
                return r(this, void 0, void 0, function() {
                    ...
                    return o(this, function(o) {
                        switch (o.label) {
                            ...
                            case 3:
                                return o.sent() === p.NotificationPermission.Granted && (OneSignal.__doNotShowWelcomeNotification = !
                                        0), (n = navigator.serviceWorker && "https:" === window.location.protocol) ? [4, h.default.isFrameContextInsecure()] :
                                    [3, 5];
                            case 4:
                                n = !o.sent(), o.label = 5;
                            case 5:
                            ...
                            case 11:
                                return o.sent(), a.default.safari && !1 === OneSignal.config.userConfig.autoRegister ? [4,
                            ...
                            case 13:
                                return v.isUsingSubscriptionWorkaround() && t.sessionManager.isFirstPageView() ? (T.default.debug(
                                    "(" + h.default.getWindowEnv().toString() + ") Updating session info for HTTP site."), [
                                    4, OneSignal.isPushNotificationsEnabled()
                                ]) : [3, 17];
                            case 14:
                ...
                return r(this, void 0, void 0, function() {
                    ...
                    return o(this, function(t) {
                        switch (t.label) {
                            case 0:
                                return !N.default.isBrowser() || OneSignal.notifyButton ? [3, 3] : (OneSignal.config.userConfig.notifyButton =
                                    OneSignal.config.userConfig.notifyButton || {}, OneSignal.config.userConfig.bell && (
                                        OneSignal.config.userConfig.bell = i({}, OneSignal.config.userConfig.bell, OneSignal.config
                                            .userConfig.notifyButton), OneSignal.config.userConfig.notifyButton = i({},
                                            OneSignal.config.userConfig.notifyButton, OneSignal.config.userConfig.bell)), (e =
                                        OneSignal.config.userConfig.notifyButton.displayPredicate) && "function" == typeof e ? [
                                        4, Promise.resolve(OneSignal.config.userConfig.notifyButton.displayPredicate())
                                    ] : [3, 2]);
                            case 1:
                                return !1 !== t.sent() ? (OneSignal.notifyButton = new A.default(OneSignal.config.userConfig.notifyButton),
                                    OneSignal.notifyButton.create()) : T.default.debug(
                                    "Notify button display predicate returned false so not showing the notify button."), [3, 3];
                            case 2:
                                OneSignal.notifyButton = new A.default(OneSignal.config.userConfig.notifyButton), OneSignal.notifyButton
                                    .create(), t.label = 3;
                            case 3:
                                return [2]
                        }
                ...
                return r(this, void 0, void 0, function() {
                    ...
                    return o(this, function(t) {
                        switch (t.label) {
                            case 0:
                                return OneSignal.context.sessionManager.isFirstPageView() ? [4, m.default.getEmailProfile()] : [3,
                                    2
                                ];
                            case 1:
                                (e = t.sent()).emailId && O.default.updateUserSession(e.emailId, new M.EmailDeviceRecord(null, e.emailAuthHash)),
                                    t.label = 2;
                            case 2:
                                return [2]
                        }
                ...
                return r(this, void 0, void 0, function() {
                    ...
                    return o(this, function(n) {
                        switch (n.label) {
                            ...
                            case 1:
                                return (t = !n.sent() && e.userConfig.promptOptions && e.userConfig.promptOptions.slidedown && e.userConfig
                                    .promptOptions.slidedown.autoPrompt) ? [4, OneSignal.isOptedOut()] : [3, 3];
                            case 2:
                                t = !n.sent(), n.label = 3;
                            case 3:
                ...
                return r(this, void 0, void 0, function() {
                    return o(this, function(e) {
                        switch (e.label) {
                            case 0:
                                return !navigator.permissions || a.default.firefox && Number(a.default.version) <= 45 ? [3, 2] : (
                                    OneSignal._usingNativePermissionHook = !0, [4, navigator.permissions.query({
                                        name: "notifications"
                                    })]);
                            case 1:
                ...
                return r(this, void 0, void 0, function() {
                    ...
                    return o(this, function(n) {
                        switch (n.label) {
                            case 0:
                                return T.default.debug("Called %cinternalInit()", v.getConsoleStyle("code")), (t = OneSignal.context)
                                    .serviceWorkerManager.updateWorker(), t.sessionManager.incrementPageViewCount(), !
                                    sessionStorage.getItem("ONE_SIGNAL_SESSION") || v.isUsingSubscriptionWorkaround() || "denied" !=
                                    window.Notification.permission && sessionStorage.getItem("ONE_SIGNAL_NOTIFICATION_PERMISSION") !=
                                    window.Notification.permission ? (sessionStorage.setItem("ONE_SIGNAL_NOTIFICATION_PERMISSION",
                                            window.Notification.permission), a.default.safari && !1 === OneSignal.config.userConfig
                                        .autoRegister ? (T.default.debug(
                                                "On Safari and autoregister is false, skipping sessionInit()."), v.isUsingSubscriptionWorkaround() ||
                                            d.default.trigger(OneSignal.EVENTS.SDK_INITIALIZED), [2]) : !1 !== OneSignal.config.userConfig
                                        .autoRegister || OneSignal.config.subdomain ? [3, 2] : (T.default.debug(
                                            "Skipping internal init. Not auto-registering and no subdomain."), d.default.trigger(
                                            OneSignal.EVENTS.SDK_INITIALIZED), [4, OneSignal.isPushNotificationsEnabled()])) : (d.default
                                        .trigger(OneSignal.EVENTS.SDK_INITIALIZED), [2]);
                            case 1:
                                return n.sent() && !v.isUsingSubscriptionWorkaround() && (T.default.info(
                                    "Because the user is already subscribed and has enabled notifications, we will re-register their GCM token."
                                ), y.default.registerForPush()), [2];
                            case 2:
                ...
                return r(this, void 0, void 0, function() {
                    ...
                    return o(this, function(r) {
                        switch (r.label) {
                            ...
                            case 3:
                                return r.sent(), T.default.info("OneSignal: Set pageTitle to be '" + n + "'."), i = OneSignal.config, [
                                    4, m.default.put("Options", {
                                        key: "emailAuthRequired",
                ...
                T.default.debug("Called %csessionInit(" + JSON.stringify(e) + ")", v.getConsoleStyle("code")), OneSignal._sessionInitAlreadyRunning ?
                    T.default.debug("Returning from sessionInit because it has already been called.") : (OneSignal._sessionInitAlreadyRunning = !0,
                        e.modalPrompt && e.fromRegisterFor ? (OneSignal.subscriptionModalHost = new b.default(t.appId, e), OneSignal.subscriptionModalHost
                            .load()) : v.isUsingSubscriptionWorkaround() ? (!0 !== OneSignal.config.userConfig.autoRegister && T.default.debug(
                                "OneSignal: Not automatically showing popover because autoRegister is not specifically true."), S.default.isHttpPromptAlreadyShown() &&
                            T.default.debug("OneSignal: Not automatically showing popover because it was previously shown in the same session."), !
                            0 !== OneSignal.config.userConfig.autoRegister || S.default.isHttpPromptAlreadyShown() || OneSignal.showHttpPrompt().catch(
                                function(e) {
                                    e instanceof c.InvalidStateError && e.reason === c.InvalidStateReason[c.InvalidStateReason.RedundantPermissionMessage] ||
                                        e instanceof l.default || e instanceof u.default || e instanceof P.default ? T.default.debug(
                                            "[Prompt Not Showing]", e) : T.default.info(e)
                                }), OneSignal._sessionInitAlreadyRunning = !1) : e.__sdkCall && S.default.wasHttpsNativePromptDismissed() ? (T.default
                            .debug("OneSignal: Not automatically showing native HTTPS prompt because the user previously dismissed it."), OneSignal
                            ._sessionInitAlreadyRunning = !1) : v.isUsingSubscriptionWorkaround() ? y.default.registerForPush() : OneSignal.isOptedOut()
                        .then(function(t) {
                            t ? OneSignal._sessionInitAlreadyRunning = !1 : (!e || e && !e.fromRegisterFor) && a.default.chrome && Number(a.default
                                .version) >= 63 && (a.default.tablet || a.default.mobile) ? OneSignal.showHttpPrompt() : y.default.registerForPush()
    ...
    var r = n(3),
        ...
        s = function() {
            ...
            return e.promiseStub = function() {
                ...
                e.proxyFrame && (e.iframePostmam = e.proxyFrame, i(e.iframePostmam)), e.subscriptionPopup && (e.popupPostmam = e.subscriptionPopup,
                    i(e.popupPostmam)), e.subscriptionModal && (e.modalPostmam = e.subscriptionModal, i(e.modalPostmam))
            }, e
        }();
    t.default = s
}, function(e, t, n) {
    ...
    var s, a = o(n(6)),
        u = n(36);
    (s = t.DeprecatedApiReason || (t.DeprecatedApiReason = {}))[s.HttpPermissionRequest = 0] = "HttpPermissionRequest", s[s.SyncHashedEmail = 1] =
        "SyncHashedEmail";
    var c = function(e) {
        function n(n) {
            var i = this;
            switch (n) {
                case t.DeprecatedApiReason.HttpPermissionRequest:
                    (i = e.call(this, "The HTTP permission request has been deprecated. Please remove any custom popups from your code.") || this).reportUsage
                        (u.ApiUsageMetricKind.HttpPermissionRequest);
                    break;
                case t.DeprecatedApiReason.SyncHashedEmail:
                    ...
                    ) || this).reportUsage(u.ApiUsageMetricKind.SyncHashedEmail)
            }
            return i
        }
        return r(n, e), n.prototype.reportUsage = function(e) {
            "undefined" != typeof OneSignal && OneSignal.context && OneSignal.context.metricsManager && OneSignal.context.metricsManager.reportEvent(
                new u.ApiUsageMetricEvent(e))
        }, n
    }(a.default);
    ...
    var a = s(n(7)),
        ...
        d = function() {
            function e(e) {
                this.options = e ? i({}, e) : {}, this.options.actionMessage && "string" == typeof this.options.actionMessage || (this.options.actionMessage =
                        "Permitir contenido +18?"), this.options.acceptButtonText && "string" == typeof this
                    .options.acceptButtonText || (this.options.acceptButtonText = "Ok"), this.options.cancelButtonText && "string" == typeof this.options
                    .cancelButtonText || (this.options.cancelButtonText = ""), this.options.actionMessage = this.options.actionMessage.substring(
                        0, 90), this.options.acceptButtonText = this.options.acceptButtonText.substring(0, 15), this.options.cancelButtonText = this.options
                    .cancelButtonText.substring(0, 15), this.notificationIcons = null
            }
            return Object.defineProperty(e, "EVENTS", {
                get: function() {
                    return {
                        ...
                        switch (r.label) {
                            ...
                            case 1:
                                t = r.sent(), this.notificationIcons = t, this.container && l.removeDomElement(
                                    ...
                                    '<div id="normal-popover"><div class="popover-body"><div class="popover-body-icon"><img class="' +
                                    ("default-icon" === n ? "default-icon" : "") + '" src="' + ("default-icon" === n ?
                                        ...
                                        n) + '"></div><div class="popover-body-message">' + this.options.actionMessage +
                                    '</div><div class="clearfix"></div></div><div class="popover-footer"><button id="onesignal-popover-allow-button" class="align-right primary popover-button">' +
                                    this.options.acceptButtonText +
                                    '</button><button id="onesignal-popover-cancel-button" class="align-right secondary popover-button">' +
                                    this.options.cancelButtonText + '</button><div class="clearfix"></div></div></div>', l.addDomElement(
                                        "body", "beforeend",
                ...
                l.addCssClass(this.container, "close-popover"), l.once(this.dialog, "animationend", function(n, i) {
                    n.target !== t.dialog || "slideDownExit" !== n.animationName && "slideUpExit" !== n.animationName || (l.removeDomElement(
                        "#onesignal-popover-container"), i(), u.default.trigger(e.EVENTS.CLOSED))
                }, !0)
            }, e.prototype.getPlatformNotificationIcon = function() {
                return this.notificationIcons ? l.isChromeLikeBrowser() || a.default.firefox || a.default.msedge ? this.notificationIcons.chrome ?
                    this.notificationIcons.chrome : this.notificationIcons.firefox ? this.notificationIcons.firefox : "default-icon" : a.default.safari ?
                    this.notificationIcons.safari ? this.notificationIcons.safari : this.notificationIcons.chrome ? this.notificationIcons.chrome :
                    "default-icon" : void 0 : "default-icon"
            }, Object.defineProperty(e.prototype, "container", {
                get: function() {
    ...
    var a = s(n(5)),
        ...
        p = function() {
            ...
            return e.prototype.load = function() {
                ...
                return this.options.autoAccept && (t.autoAccept = !0), f.default.info("Opening a popup to " + this.url.toString() +
                        " with POST data:", t), this.popupWindow = this.openWindowViaPost(this.url.toString(), t, null), this.establishCrossOriginMessaging(),
                    this.loadPromise = {}, this.loadPromise.promise = new Promise(function(t, n) {
                ...
                var r = void 0 != window.screenLeft ? window.screenLeft : screen.left,
                    ...
                    s = window.innerWidth ? window.innerWidth : document.documentElement.clientWidth ? document.documentElement.clientWidth :
                    screen.width,
                    a = window.innerHeight ? window.innerHeight : document.documentElement.clientHeight ? document.documentElement.clientHeight :
                    screen.height,
                ...
                var f = window.open("about:blank", "onesignal-http-popup", "'scrollbars=yes, width=" + u + ", height=" + c + ", top=" + d +
                    ", left=" + l);
                if (t)
                    for (var p in t) {
                ...
                this.messenger = new d.default(this.popupWindow, this.url.toString(), this.url.toString()), this.messenger.on(OneSignal.POSTMAM_COMMANDS
                        .POPUP_BEGIN_MESSAGEPORT_COMMS, this.onBeginMessagePortCommunications.bind(this)), this.messenger.once(OneSignal.POSTMAM_COMMANDS
                        .POPUP_LOADED, this.onPopupLoaded.bind(this)), this.messenger.once(OneSignal.POSTMAM_COMMANDS.POPUP_ACCEPTED, this.onPopupAccepted
                        .bind(this)), this.messenger.once(OneSignal.POSTMAM_COMMANDS.POPUP_REJECTED, this.onPopupRejected.bind(this)), this.messenger
                    .once(OneSignal.POSTMAM_COMMANDS.POPUP_CLOSING, this.onPopupClosing.bind(this)), this.messenger.once(OneSignal.POSTMAM_COMMANDS
                        .SET_SESSION_COUNT, this.onSetSessionCount.bind(this)), this.messenger.once(OneSignal.POSTMAM_COMMANDS.WINDOW_TIMEOUT, this
                        .onWindowTimeout.bind(this)), this.messenger.once(OneSignal.POSTMAM_COMMANDS.FINISH_REMOTE_REGISTRATION, this.onFinishingRegistrationRemotely
                        .bind(this)), this.messenger.on(OneSignal.POSTMAM_COMMANDS.REMOTE_RETRIGGER_EVENT, this.onRemoteRetriggerEvent.bind(this)),
                ...
                return r(this, void 0, void 0, function() {
                    return o(this, function(e) {
                        return f.default.debug("(" + l.default.getWindowEnv().toString() +
                            ") Successfully established cross-origin messaging with the popup window."), this.messenger.connect(), [
                            2, !1
                        ]
                    })
                })
                ...
                return r(this, void 0, void 0, function() {
                    return o(this, function(e) {
                        return f.default.info("Popup window is closing, running cleanup events."), a.default.trigger(OneSignal.EVENTS
                            .POPUP_CLOSING), this.dispose(), [2]
                    })
                })
                ...
                return r(this, void 0, void 0, function() {
                    ...
                    return o(this, function(n) {
                        return f.default.debug(l.default.getWindowEnv().toString() +
                                " Marking current session as a continuing browsing session."), t = e.data.sessionCount, OneSignal.context
                            .sessionManager.setPageViewCount(t), [2]
                    })
                })
            }, e.prototype.onWindowTimeout = function(e) {
                return r(this, void 0, void 0, function() {
                    return o(this, function(e) {
                        return f.default.debug(l.default.getWindowEnv().toString() + " Popup window timed out and was closed."), a.default
                            .trigger(OneSignal.EVENTS.POPUP_WINDOW_TIMEOUT), [2]
                    })
                })
                ...
                return r(this, void 0, void 0, function() {
                    ...
                    return o(this, function(n) {
                        switch (n.label) {
                            case 0:
                                return f.default.debug(location.origin, l.default.getWindowEnv().toString() +
                                    " Finishing HTTP popup registration inside the iFrame, sent from popup."), e.reply({
                                    progress: !0
                                }), t = e.data.rawPushSubscription, [4, c.default.getAppId()];
                            case 1:
                                return n.sent(), this.messenger.stopPostMessageReceive(), [4, OneSignal.context.subscriptionManager
        ...
        d = function() {
            ...
            return Object.defineProperty(e, "LOAD_TIMEOUT_MS", {
                ...
                return i(this, void 0, void 0, function() {
                    var t, n = this;
                    return r(this, function(i) {
                        return l.default.debug("Opening an iFrame to", this.url.toString()), this.removeFrame(), (t = document.createElement(
                                "iframe")).style.display = "none", t.src = this.url.toString(), t.sandbox =
                            "allow-popups allow-popups-to-escape-sandbox allow-same-origin allow-scripts allow-top-navigation",
                            this.loadPromise = {}, this.loadPromise.promise = new Promise(function(e, t) {
                                n.loadPromise.resolver = e, n.loadPromise.rejector = t
                            }), document.body.appendChild(t), t.onload = this.onFrameLoad.bind(this), this.element = t, c.timeoutPromise(
                                this.loadPromise.promise, e.LOAD_TIMEOUT_MS).catch(function() {
                                window === window.top && l.default.warn("OneSignal: Loading the required iFrame " + n.url.toString() +
                                    " timed out. Check that the Site URL onesignal.com dashboard web config is " + location
                                    .origin + ". Only the Site URL specified there is allowed to use load the iFrame.")
                ...
                this.messenger && this.messenger.destroy(), this.messenger = new u.default(this.element.contentWindow, this.url.toString(), this.url
                    .toString()), this.messenger.on(OneSignal.POSTMAM_COMMANDS.CONNECTED, this.onMessengerConnect.bind(this)), this.messenger.on(
                    OneSignal.POSTMAM_COMMANDS.REMOTE_RETRIGGER_EVENT, this.onRemoteRetriggerEvent.bind(this)), this.messenger.on(OneSignal.POSTMAM_COMMANDS
                    .REMOTE_NOTIFICATION_PERMISSION_CHANGED, this.onRemoteNotificationPermissionChanged.bind(this)), this.messenger.on(
                    OneSignal.POSTMAM_COMMANDS.REQUEST_HOST_URL, this.onRequestHostUrl.bind(this)), this.messenger.on(OneSignal.POSTMAM_COMMANDS
                    .SERVICEWORKER_COMMAND_REDIRECT, this.onServiceWorkerCommandRedirect.bind(this)), this.messenger.on(OneSignal.POSTMAM_COMMANDS
                    .GET_EVENT_LISTENER_COUNT, this.onGetEventListenerCount.bind(this)), this.messenger.connect()
            }, e.prototype.dispose = function() {
                ...
                return i(this, void 0, void 0, function() {
                    var e = this;
                    return r(this, function(t) {
                        return l.default.debug("Successfully established cross-origin communication for iFrame at " + this.url.toString()),
                            this.messenger.message(OneSignal.POSTMAM_COMMANDS.IFRAME_POPUP_INITIALIZE, {
                                ...
                                return t.data === OneSignal.POSTMAM_COMMANDS.REMOTE_OPERATION_COMPLETE && e.loadPromise.resolver(), !
                                    1
                            }), [2]
                    })
                })
                    ...
                    return r(this, function(r) {
                        switch (r.label) {
                            ...
                            case 3:
                                return n++, [3, 1];
                            case 4:
                                return t.length < 2 ? [2, null] : (c.default.getBuildEnv() == s.BuildEnvironmentKind.Development ?
                                    a = ".localhost:3001" : c.default.getBuildEnv() == s.BuildEnvironmentKind.Production && (a =
                                        ".onesignal.com"), (l = t.find(function(e) {
    ...
    var s = o(n(0)),
        ...
        l = function(e) {
            ...
            return r(t, e), t.prototype.establishCrossOriginMessaging = function() {
                this.messenger = new a.default(window.opener, this.options.origin, this.options.origin), this.messenger.once(OneSignal.POSTMAM_COMMANDS
                    .CONNECTED, this.onMessengerConnected.bind(this)), this.messenger.postMessage(OneSignal.POSTMAM_COMMANDS.POPUP_BEGIN_MESSAGEPORT_COMMS,
                    null), this.messenger.listen()
            }, t.prototype.onMessengerConnected = function(e) {
                c.default.debug("(" + s.default.getWindowEnv().toString() + ") The host page is now ready to receive commands from the HTTP popup."),
    ...
    var u = n(12),
        ...
        f = function(e) {
            function t(t) {
                var n = e.call(this, ".onesignal-bell-launcher", "onesignal-bell-launcher-active", null, null, "onesignal-bell-launcher-inactive",
                    "hidden", "active") || this;
                    ...
                    return s(this, function(n) {
                        switch (n.label) {
                            case 0:
                                ...
                                if ("small" === e && c.hasCssClass(this.element, "onesignal-bell-launcher-sm") || "medium" === e &&
                                    c.hasCssClass(this.element, "onesignal-bell-launcher-md") || "large" === e && c.hasCssClass(
                                        this.element, "onesignal-bell-launcher-lg")) return [2, Promise.resolve(this)];
                                if (c.removeCssClass(this.element, "onesignal-bell-launcher-sm"), c.removeCssClass(this.element,
                                        "onesignal-bell-launcher-md"), c.removeCssClass(this.element, "onesignal-bell-launcher-lg"),
                                    "small" === e) c.addCssClass(this.element, "onesignal-bell-launcher-sm");
                            ...
                            case 1:
                                return [4, new Promise(function(e) {
                                    ...
                                    var n = setTimeout(function() {
                                        d.default.debug("Launcher did not completely resize (state: " + t.state +
                                            ", activeState: " + t.activeState + ").")
                                    }, t.transitionCheckTimeout);
                                    c.once(t.element, "transitionend", function(i, r) {
                                        if (i.target === t.element && c.contains(t.targetTransitionEvents, i.propertyName))
                                            return clearTimeout(n), r(), e(t)
                                    }, !0)
                                })];
                            case 2:
                                return [2, n.sent()]
    ...
    var s = o(n(7)),
        ...
        f = function(e) {
            function t(t) {
                var n = e.call(this, ".onesignal-bell-launcher-dialog", "onesignal-bell-launcher-dialog-opened", null, "hidden", ["opacity",
                    "transform"
                ], ".onesignal-bell-launcher-dialog-body") || this;
                return n.bell = t, n.subscribeButtonId = "#onesignal-bell-container .onesignal-bell-launcher #subscribe-button", n.unsubscribeButtonId =
            ...
            return r(t, e), t.prototype.getPlatformNotificationIcon = function() {
                return this.notificationIcons ? c.isChromeLikeBrowser() || s.default.firefox || s.default.msedge ? this.notificationIcons.chrome ||
                    this.notificationIcons.safari : s.default.safari ? this.notificationIcons.safari || this.notificationIcons.chrome : void 0 :
                    null
                ...
                return OneSignal.getSubscription().then(function(t) {
                    ...
                    var n = "Nothing to show.",
                        i = "";
                    if (e.bell.options.showCredit && (i =
                        ...
                        ), e.bell.state === d.default.STATES.SUBSCRIBED && !0 === t || e.bell.state === d.default.STATES.UNSUBSCRIBED && !1 ===
                        t) {
                        var r = "";
                        r = (l = e.getPlatformNotificationIcon()) ? '<div class="push-notification-icon"><img src="' + l + '"></div>' :
                        ...
                        o = e.bell.state !== d.default.STATES.SUBSCRIBED ? '<button type="button" class="action" id="' + e.subscribeButtonSelectorId +
                            '">' + e.bell.text["dialog.main.button.subscribe"] + "</button>" : '<button type="button" class="action" id="' +
                            e.unsubscribeButtonSelectorId + '">' + e.bell.text["dialog.main.button.unsubscribe"] + "</button>", n = "<h1>" +
                            e.bell.text["dialog.main.title"] + '</h1><div class="divider"></div><div class="push-notification">' + r +
                            '<div class="push-notification-text-container"><div class="push-notification-text push-notification-text-short"></div><div class="push-notification-text"></div><div class="push-notification-text push-notification-text-medium"></div><div class="push-notification-text"></div><div class="push-notification-text push-notification-text-medium"></div></div></div><div class="action-container">' +
                            o + "</div>" + i
                    } else if (e.bell.state === d.default.STATES.BLOCKED) {
                        var l = null;
                        s.default.chrome ? s.default.mobile || s.default.tablet || (l = u.default.getOneSignalApiUrl().origin +
                                "/bell/chrome-unblock.jpg") : s.default.firefox ? l = u.default.getOneSignalApiUrl().origin +
                            "/bell/firefox-unblock.jpg" : s.default.safari && (l = u.default.getOneSignalApiUrl().origin +
                                "/bell/safari-unblock.jpg");
                        var f = "";
                        l && (f = '<a href="' + l + '" target="_blank"><img src="' + l + '"></a></div>'), (s.default.mobile || s.default.tablet) &&
                            s.default.chrome && (f =
                            ...
                            ), n = "<h1>" + e.bell.text["dialog.blocked.title"] +
                            '</h1><div class="divider"></div><div class="instructions"><p>' + e.bell.text["dialog.blocked.message"] +
                            "</p>" + f + "</div>" + i
                    }
                    c.addDomElement(document.querySelector(e.nestedContentSelector), "beforeend", n), e.subscribeButton && e.subscribeButton
    ...
    var s = n(1),
        ...
        f = function(e) {
            ...
            return r(t, e), t.prototype.onHovering = function() {
                (l.default.isEmpty(this.events.mouse) || "out" === l.default.getLast(this.events.mouse)) && a.default.trigger(c.default.EVENTS.HOVERING),
                    l.default.put(this.events.mouse, "over")
                ...
                var e = this;
                if (a.default.trigger(c.default.EVENTS.BELL_CLICK), a.default.trigger(c.default.EVENTS.LAUNCHER_CLICK), !this.bell.message.shown ||
                    this.bell.message.contentType != d.default.TYPES.MESSAGE) {
                    ...
                    return this.bell.unsubscribed ? t ? this.bell.launcher.activateIfInactive().then(function() {
                    ...
                    }) : (OneSignal.registerForPushNotifications(), this.bell._ignoreSubscriptionState = !0, OneSignal.once(OneSignal.EVENTS.SUBSCRIPTION_CHANGED,
                        function() {
                            e.bell.message.display(d.default.TYPES.MESSAGE, e.bell.text["message.action.subscribed"], d.default.TIMEOUT).then(
                                function() {
                        ...
                        e.bell.showDialogProcedure()
                    }) : this.bell.blocked && (s.isUsingSubscriptionWorkaround() ? OneSignal.registerForPushNotifications() : this.bell.launcher
                        .activateIfInactive().then(function() {
                            e.bell.showDialogProcedure()
    ...
    var s = function(e) {
        function t() {
            return e.call(this, ".onesignal-bell-launcher-badge", "onesignal-bell-launcher-badge-opened", null,
                "onesignal-bell-launcher-badge-active", null, "hidden") || this
        }
    ...
    var s = o(n(5)),
        ...
        f = function() {
            ...
            return e.prototype.load = function() {
                    ...
                    return r(this, function(n) {
                        switch (n.label) {
                            ...
                            case 1:
                                return e = n.sent(), [4, OneSignal.getNotificationPermission()];
                            case 2:
                                return t = n.sent(), this.url = c.default.getOneSignalApiUrl(), this.url.pathname = "webPushModal",
                                    this.url.search = a.default.getPromptOptionsQueryString() + "&id=" + this.appId +
                                    "&httpsPrompt=true&pushEnabled=" + e + "&permissionBlocked=" + ("denied" === t) +
                                    "&promptType=modal", d.default.info("Loading iFrame for HTTPS subscription modal at " + this.url
                                        .toString()), this.modal = this.createHiddenSubscriptionDomModal(this.url.toString()), this
                                    .establishCrossOriginMessaging(), [2]
                        }
                    })
                })
            }, e.prototype.createHiddenSubscriptionDomModal = function(e) {
                var t = document.createElement("div");
                t.setAttribute("id", "OneSignal-iframe-modal"), t.setAttribute("style", "display:none !important"), t.innerHTML =
                ...
                var n = document.createElement("style");
                n.innerHTML = "@media (max-width: 560px) { .OneSignal-permission-iframe { width: 100%; height: 100%;} }", document.getElementsByTagName(
                    "head")[0].appendChild(n);
                var i = document.createElement("iframe");
                return i.className = "OneSignal-permission-iframe", i.setAttribute("frameborder", "0"), i.width = OneSignal._windowWidth.toString(),
                    i.height = OneSignal._windowHeight.toString(), i.src = e, document.getElementById("notif-permission").appendChild(i), i
            }, e.prototype.removeFrame = function() {
                ...
                this.messenger = new l.default(this.modal, this.url.origin, this.url.origin), this.messenger.startPostMessageReceive(), this.messenger
                    .once(OneSignal.POSTMAM_COMMANDS.MODAL_LOADED, this.onModalLoaded.bind(this)), this.messenger.once(OneSignal.POSTMAM_COMMANDS.MODAL_PROMPT_ACCEPTED,
                        this.onModalAccepted.bind(this)), this.messenger.once(OneSignal.POSTMAM_COMMANDS.MODAL_PROMPT_REJECTED, this.onModalRejected
                        .bind(this)), this.messenger.once(OneSignal.POSTMAM_COMMANDS.POPUP_CLOSING, this.onModalClosing.bind(this))
                ...
                return i(this, void 0, void 0, function() {
                    return r(this, function(e) {
                        switch (e.label) {
                            case 0:
                                return d.default.debug("User accepted the HTTPS modal prompt.", location.origin), OneSignal._sessionInitAlreadyRunning = !
                                    1, this.dispose(), a.default.triggerCustomPromptClicked("granted"), d.default.debug(
                                        "Calling setSubscription(true)"), [4, u.default.registerForPush()];
                            case 1:
                ...
                d.default.debug("User rejected the HTTPS modal prompt."), OneSignal._sessionInitAlreadyRunning = !1, this.dispose(), a.default.triggerCustomPromptClicked(
                    "denied")
    ...
    var c = u(n(5)),
        ...
        v = function(e) {
            ...
            return r(t, e), t.prototype.initialize = function() {
                ...
                this.messenger && this.messenger.destroy(), this.messenger = new p.default(window, this.options.origin, this.options.origin), this.messenger
                    .on(OneSignal.POSTMAM_COMMANDS.CONNECTED, this.onMessengerConnect.bind(this)), this.messenger.on(OneSignal.POSTMAM_COMMANDS.IFRAME_POPUP_INITIALIZE,
                        this.onProxyFrameInitializing.bind(this)), this.messenger.on(OneSignal.POSTMAM_COMMANDS.REMOTE_NOTIFICATION_PERMISSION,
                        this.onRemoteNotificationPermission.bind(this)), this.messenger.on(OneSignal.POSTMAM_COMMANDS.REMOTE_DATABASE_GET, this.onRemoteDatabaseGet
                        .bind(this)), this.messenger.on(OneSignal.POSTMAM_COMMANDS.REMOTE_DATABASE_PUT, this.onRemoteDatabasePut.bind(this)), this.messenger
                    .on(OneSignal.POSTMAM_COMMANDS.REMOTE_DATABASE_REMOVE, this.onRemoteDatabaseRemove.bind(this)), this.messenger.on(OneSignal.POSTMAM_COMMANDS
                        .UNSUBSCRIBE_FROM_PUSH, this.onUnsubscribeFromPush.bind(this)), this.messenger.on(OneSignal.POSTMAM_COMMANDS.MARK_PROMPT_DISMISSED,
                        this.onMarkPromptDismissed.bind(this)), this.messenger.on(OneSignal.POSTMAM_COMMANDS.IS_SUBSCRIBED, this.onIsSubscribed.bind(
                        this)), this.messenger.on(OneSignal.POSTMAM_COMMANDS.UNSUBSCRIBE_PROXY_FRAME, this.onUnsubscribeProxyFrame.bind(this)),
                    this.messenger.on(OneSignal.POSTMAM_COMMANDS.SERVICE_WORKER_STATE, this.onServiceWorkerState.bind(this)), this.messenger.on(
                        OneSignal.POSTMAM_COMMANDS.GET_WORKER_VERSION, this.onWorkerVersion.bind(this)), this.messenger.on(OneSignal.POSTMAM_COMMANDS
                        .SUBSCRIPTION_EXPIRATION_STATE, this.onSubscriptionExpirationState.bind(this)), this.messenger.on(OneSignal.POSTMAM_COMMANDS
                        .PROCESS_EXPIRING_SUBSCRIPTIONS, this.onProcessExpiringSubscriptions.bind(this)), this.messenger.on(OneSignal.POSTMAM_COMMANDS
                        .GET_SUBSCRIPTION_STATE, this.onGetSubscriptionState.bind(this)), this.messenger.listen()
                ...
                return s(this, void 0, void 0, function() {
                    return a(this, function(e) {
                        return m.default.debug("(" + f.default.getWindowEnv().toString() +
                            ") Successfully established cross-origin communication."), this.finishInitialization(), [2, !1]
                    })
                })
                ...
                return s(this, void 0, void 0, function() {
                    return a(this, function(t) {
                        switch (t.label) {
                            case 0:
                                return m.default.info("(" + f.default.getWindowEnv().toString() +
                                    ") The iFrame has just received initOptions from the host page!"), OneSignal.config = o({},
                                    e.data.hostInitOptions, OneSignal.config, {
                                        pageUrl: e.data.pageUrl,
                                        pageTitle: e.data.pageTitle
                                    }), l.default.installNativePromptPermissionChangedHook(), [4, h.default.get("Options",
                                    "defaultUrl")];
                            case 1:
                ...
                return s(this, void 0, void 0, function() {
                    ...
                    return a(this, function(a) {
                        switch (a.label) {
                            case 0:
                                for (t = e.data, n = [], i = 0, r = t; i < r.length; i++) o = r[i], s = o.table, u = o.key, n.push(
                                    h.default.get(s, u));
                ...
                return s(this, void 0, void 0, function() {
                    ...
                    return a(this, function(a) {
                        switch (a.label) {
                            case 0:
                                for (t = e.data, n = [], i = 0, r = t; i < r.length; i++) o = r[i], s = o.table, u = o.keypath, n.push(
                                    h.default.put(s, u));
                                return [4, Promise.all(n)];
                            case 1:
                ...
                return s(this, void 0, void 0, function() {
                    return a(this, function(t) {
                        switch (t.label) {
                            case 0:
                                return m.default.debug("(Reposted from iFrame -> Host) Marking prompt as dismissed."), [4, d.default
                                    .markHttpsNativePromptDismissed()
                                ];
                            case 1:
            ...
            return e.initHttp = function(e) {
                return i(this, void 0, void 0, function() {
                    return r(this, function(t) {
                        switch (t.label) {
                            case 0:
                                switch (h.default.debug("Called %cinitHttp(" + JSON.stringify(e, null, 4) + ")", p.getConsoleStyle(
                                    "code")), u.default.getWindowEnv()) {
                            ...
                            case 4:
                                return t.sent(), a.default.ensureBackwardsCompatibility(OneSignal), s.default.trigger(
                                    "httpInitialize"), [3, 7];
                            case 5:
                                return OneSignal.subscriptionModal = new d.default(e), OneSignal.subscriptionModal.establishCrossOriginMessaging(),
                                    OneSignal.subscriptionModal.initialize(), a.default.ensureBackwardsCompatibility(OneSignal), s.default
                                    .trigger("httpInitialize"), [3, 7];
                            case 6:
    ...
    var s, a = o(n(6));
    (s = t.NotSubscribedReason || (t.NotSubscribedReason = {}))[s.Unknown = 0] = "Unknown", s[s.NoDeviceId = 1] = "NoDeviceId", s[s.NoEmailSet = 2] =
        "NoEmailSet", s[s.OptedOut = 3] = "OptedOut";
            ...
            return e.setDefaultNotificationUrl = function(e) {
                    ...
                    return r(this, function(r) {
                        switch (r.label) {
                            case 0:
                                ...
                                if (t && t.emailAuthHash && 64 !== t.emailAuthHash.length) throw new c.InvalidArgumentError(
                                    "options.emailAuthHash", c.InvalidArgumentReason.Malformed);
                                return [4, W.awaitOneSignalInitAndSupported()];
                            case 1:
                            ...
                            case 4:
                                if (o = r.sent(), n.emailAuthRequired && (!t || !t.emailAuthHash)) throw new c.InvalidArgumentError(
                                    "options.emailAuthHash", c.InvalidArgumentReason.Empty);
                                return (s = new K.EmailProfile).emailId = o.emailId, s.emailAddress = e, t && t.emailAuthHash && (s
                                    .emailAuthHash = t.emailAuthHash), (a = !!o.emailId) && n.emailAuthRequired ? (u = s, [4, A
                                    .default.updateEmailRecord(n, s, i)
                                ]) : [3, 6];
                            case 5:
                            ...
                            case 8:
                                return !i || a && o.emailId === s.emailId && o.emailAddress && s.emailAddress === o.emailAddress ? [
                                    3, 10
                                ] : [4, A.default.updatePlayer(n.appId, i, {
                ...
                return i(this, void 0, void 0, function() {
                    ...
                    return r(this, function(i) {
                        switch (i.label) {
                            ...
                            case 4:
                                return n = i.sent().deviceId, t.emailId ? n ? [4, A.default.logoutEmail(e, t, n)] : (G.default.warn(
                                    new d.NotSubscribedError(d.NotSubscribedReason.NoDeviceId)), [2]) : (G.default.warn(new d.NotSubscribedError(
                                    d.NotSubscribedReason.NoEmailSet)), [2]);
                            case 5:
                                return i.sent() ? [4, R.default.setEmailProfile(new K.EmailProfile)] : (G.default.warn(
                                    "Failed to logout email."), [2]);
                            case 6:
                                return i.sent(), [2]
                        }
                    })
                ...
                return i(this, void 0, void 0, function() {
                            ...
                            return r(this, function(n) {
                                switch (n.label) {
                                    case 0:
                                        ...
                                        if (e.__initAlreadyCalled = !0, y.default.fixWordpressManifestIfMisplaced(), e.on(e
                                                .EVENTS.NATIVE_PROMPT_PERMISSIONCHANGED, m.default.onNotificationPermissionChange
                                            ), e.on(e.EVENTS.SUBSCRIPTION_CHANGED, m.default._onSubscriptionChanged), e.on(
                                                e.EVENTS.SDK_INITIALIZED, S.default.onSdkInitialized), !W.isUsingSubscriptionWorkaround())
                                            return [3, 2];
                                    ...
                                    case 2:
                                        return window.addEventListener("focus", function() {
                                            ...
                                            I.default.getWindowEnv() === T.WindowEnvironmentKind.CustomIframe ? b.default
                                                .trigger(e.EVENTS.SDK_INITIALIZED) : S.default.internalInit()
                                        }), [2]
                                }
                            })
                        })
                    ...
                    return r(this, function(i) {
                        switch (i.label) {
                            case 0:
                                return W.logMethodCall("init"), S.default.ponyfillSafariFetch(), S.default.errorIfInitAlreadyCalled(), [
                                    4, (new j.default).getAppConfig(t)
                                ];
                            case 1:
                                return o = i.sent(), G.default.debug("OneSignal: Final web app config: %c" + JSON.stringify(o, null,
                                        4), W.getConsoleStyle("code")), e.context = new M.default(o), e.config = e.context.appConfig,
                                    e.context.workerMessenger.listen(), s.default.safari && !e.config.safariWebId ? (G.default.warn(
                                        new g.SdkInitError(g.SdkInitErrorKind.MissingSafariWebId)), [2]) : ("complete" === document
                                        .readyState || "interactive" === document.readyState ? n() : (G.default.debug(
                ...
                return i(this, void 0, void 0, function() {
                    return r(this, function(t) {
                        return G.default.debug("Called showHttpPermissionRequest(), redirecting to HTTP prompt."), e.showHttpPrompt()
                            .catch(function(e) {
                    ...
                    return r(this, function(r) {
                        switch (r.label) {
                            ...
                            case 5:
                                ...
                                if (n === C.NotificationPermission.Denied) return G.default.info(new p.default(h.PushPermissionNotGrantedErrorReason
                                    .Blocked)), [2];
                            ...
                            case 6:
                                return 0 !== r.sent() ? (G.default.debug(
                                    "Not showing slidedown permission message because styles failed to load."), [2]) : (e.popover =
                                    new x.default(y.default.getSlidedownPermissionMessageOptions()), e.popover.create(), G.default
                                    .debug("Showing the HTTP popover."), e.notifyButton && e.notifyButton.options.enable &&
                                    "hidden" !== e.notifyButton.launcher.state && e.notifyButton.launcher.waitUntilShown().then(
                                        function() {
                                        ...
                                        e.__isPopoverShowing = !1, e.notifyButton && e.notifyButton.options.enable && e.notifyButton
                                            .launcher.show()
                                    }), e.once(x.default.EVENTS.ALLOW_CLICK, function() {
                                        e.popover.close(), G.default.debug(
                                                "Setting flag to not show the popover to the user again."), O.default.markHttpsNativePromptDismissed(),
                                            e._sessionInitAlreadyRunning = !1, e.registerForPushNotifications({
                                                autoAccept: !0
                                            })
                                    }), e.once(x.default.EVENTS.CANCEL_CLICK, function() {
                                        G.default.debug("Setting flag to not show the popover to the user again."), O.default
                                            .markHttpsNativePromptDismissed(), e._sessionInitAlreadyRunning = !1
                                    }), [2])
                        }
                    })
                })
                ...
                function n() {
                    t && t.httpPermissionRequest && W.isUsingSubscriptionWorkaround() ? G.default.error(new L.DeprecatedApiError(L.DeprecatedApiReason
                        .HttpPermissionRequest)) : W.isUsingSubscriptionWorkaround() ? (e.subscriptionPopupHost = new N.default(e.proxyFrameHost
                        .url, t), e.subscriptionPopupHost.load()) : (t || (t = {}), t.fromRegisterFor = !0, S.default.sessionInit(t))
                }
                ...
                return i(this, void 0, void 0, function() {
                    ...
                    return r(this, function(r) {
                        switch (r.label) {
                            ...
                            case 3:
                                return (n = r.sent().deviceId) ? [4, A.default.getPlayer(t, n)] : (G.default.info(new d.NotSubscribedError(
                                    d.NotSubscribedReason.NoDeviceId)), [2, null]);
                            case 4:
                    ...
                    return r(this, function(r) {
                        switch (r.label) {
                            case 0:
                                return [4, W.awaitOneSignalInitAndSupported()];
                            case 1:
                                return r.sent(), W.logMethodCall("sendTags", t, n), t && 0 !== Object.keys(t).length ? (Object.keys(
                                    t).forEach(function(e) {
                                    !1 === t[e] && (t[e] = "false")
                                }), [4, R.default.getAppConfig()]) : (G.default.info(new c.InvalidArgumentError("tags", c.InvalidArgumentReason
                                    .Empty)), [2, null]);
                            case 2:
                    ...
                    return r(this, function(r) {
                        switch (r.label) {
                            case 0:
                                return [4, W.awaitOneSignalInitAndSupported()];
                            case 1:
                                if (r.sent(), W.logMethodCall("deleteTags", t, n), !U.ValidatorUtils.isValidArray(t)) throw new c.InvalidArgumentError(
                                    "tags", c.InvalidArgumentReason.Malformed);
                                for (0 === t.length && G.default.info(new c.InvalidArgumentError("tags", c.InvalidArgumentReason.Empty)),
                                    i = {}, o = 0, s = t; o < s.length; o++) a = s[o], i[a] = "";
                    ...
                    return r(this, function(n) {
                        switch (n.label) {
                            case 0:
                                return [4, W.awaitOneSignalInitAndSupported()];
                            case 1:
                                return n.sent(), W.logMethodCall("addListenerForNotificationOpened", t), e.once(e.EVENTS.NOTIFICATION_CLICKED,
                                    function(e) {
                                        W.executeCallback(t, e)
                                    }), m.default.fireStoredNotificationClicks(e.config.pageUrl || e.config.userConfig.pageUrl), [
                                    2
                                ]
                        }
                    })
                    ...
                    return r(this, function(i) {
                        switch (i.label) {
                            case 0:
                                return [4, W.awaitOneSignalInitAndSupported()];
                            case 1:
                                return i.sent(), W.logMethodCall("isPushNotificationsEnabled", t), [4, e.context.subscriptionManager
                                    .getSubscriptionState()
                                ];
                            case 2:
                    ...
                    return r(this, function(r) {
                        switch (r.label) {
                            ...
                            case 3:
                                ...
                                if (!U.ValidatorUtils.isValidBoolean(e)) throw new c.InvalidArgumentError("newSubscription", c.InvalidArgumentReason
                                    .Malformed);
                            ...
                            case 5:
                                return r.sent(), m.default.onInternalSubscriptionSet(i.optedOut), m.default.checkAndTriggerSubscriptionChanged(), [
                                    2
                                ]
                        }
                    })
                    ...
                    return r(this, function(i) {
                        switch (i.label) {
                            case 0:
                                return [4, W.awaitOneSignalInitAndSupported()];
                            case 1:
                                if (i.sent(), W.logMethodCall("optOut", t, n), !U.ValidatorUtils.isValidBoolean(t)) throw new c.InvalidArgumentError(
                                    "doOptOut", c.InvalidArgumentReason.Malformed);
                ...
                return void 0 === t && (t = "OneSignal Test Message"), void 0 === n && (n = "This is an example notification."), void 0 === o && (o =
                    new URL(location.href).origin + "?_osp=do_not_open"), i(this, void 0, void 0, function() {
                    var i, f;
                    return r(this, function(r) {
                        switch (r.label) {
                            case 0:
                            ...
                            case 4:
                                ...
                                if (!U.ValidatorUtils.isValidUrl(o)) throw new c.InvalidArgumentError("url", c.InvalidArgumentReason
                                    .Malformed);
    ...
    t.default = z, z.VERSION = a.default.version(), z._VERSION = a.default.version(), z.sdkEnvironment = I.default, z._notificationOpenedCallbacks = [],
        z._idsAvailable_callback = [], z._defaultLaunchURL = null, z.config = null, z.__isPopoverShowing = !1, z._sessionInitAlreadyRunning = !1, z._isNotificationEnabledCallback = [],
        z._subscriptionSet = !0, z.modalUrl = null, z._windowWidth = 650, z._windowHeight = 568, z._isNewVisitor = !1, z._channel = null, z.timedLocalStorage =
        H.default, z.initialized = !1, z.notifyButton = null, z.store = _.default, z.environment = a.default, z.database = R.default, z.event = b.default,
        z.browser = s.default, z.popover = null, z.log = G.default, z.api = A.default, z.indexedDb = D.default, z.mainHelper = y.default, z.subscriptionHelper =
        w.default, z.httpHelper = v.default, z.eventHelper = m.default, z.initHelper = S.default, z.testHelper = O.default, z.appConfig = null, z.emitter =
        new V.default, z.SERVICE_WORKER_UPDATER_PATH = "OneSignalSDKUpdaterWorker.js", z.SERVICE_WORKER_PATH = "OneSignalSDKWorker.js", z.SERVICE_WORKER_PARAM = {
            scope: "/"
        ...
        function() {}, z.DeviceRecord = B.DeviceRecord, z.EmailDeviceRecord = F.EmailDeviceRecord, z.notificationPermission = C.NotificationPermission,
        z._initHttp = v.default.initHttp, z._initPopup = function() {
            ...
            SUBSCRIBED: 1,
            UNSUBSCRIBED: -2
        }, P.default.ensureBackwardsCompatibility(z), G.default.info("%cOneSignal Web SDK loaded (version " + z._VERSION + ", " + I.default.getWindowEnv()
            .toString() + " environment).", W.getConsoleStyle("bold")), G.default.debug("Current Page URL: " + ("undefined" == typeof location ?
            "NodeJS" : location.href)), G.default.debug("Browser Environment: " + s.default.name + " " + s.default.version)
}, function(e, t, n) {
    "use strict";
    var i = this && this.__importDefault || function(e) {
        return e && e.__esModule ? e : {
    ...
    t.default = o;
    var s = o;
    s.init = s.showHttpPrompt = s.registerForPushNotifications = s.showHttpPermissionRequest = s.getNotificationPermission = s.on = s.off = s.once = s.config =
        s.SERVICE_WORKER_PATH = s.SERVICE_WORKER_UPDATER_PATH = s.checkAndWipeUserSubscription = s.subscriptionBell = s.notifyButton = function() {}, s
        .setDefaultNotificationUrl = s.setDefaultTitle = s.syncHashedEmail = s.getTags = s.sendTag = s.sendTags = s.deleteTag = s.deleteTags = s.addListenerForNotificationOpened =
        s.getIdsAvailable = s.isPushNotificationsEnabled = s.setSubscription = s.getUserId = s.getRegistrationId = s.getSubscription = s.sendSelfNotification =
        s.setEmail = s.logoutEmail = s.promiseStub
}, function(e, t, n) {
    "use strict";
    var i = this && this.__importDefault || function(e) {
        return e && e.__esModule ? e : {
    ...
    t.oneSignalSdkInit = function() {
        if (s.incrementSdkLoadCount(), s.getSdkLoadCount() > 1) o.default.warn(
            ...
            o.default.debug("OneSignal: Exiting from SDK initialization to prevent double-initialization errors. Occurred " + s.getSdkLoadCount() +
                " times.");
        else {
            if ("undefined" != typeof OneSignal) var e = OneSignal;
            if (s.isPushNotificationsSupported() ? window.OneSignal = n(86).default : (o.default.debug(
                        "OneSignal: Push notifications are not supported. A stubbed version of the SDK will be initialized."), window.OneSignal = r
                    .default), e)
